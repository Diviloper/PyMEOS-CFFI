...
/* extern bool type_span_bbox(meosType type);  (undefined) */
/* extern bool span_tbox_type(meosType type);  (undefined) */
/* extern bool ensure_span_tbox_type(meosType type);  (undefined) */
