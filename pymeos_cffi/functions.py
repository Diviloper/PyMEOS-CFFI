...
def create_pointer(object: "Any", type: str) -> Annotated[FFI.CData, "Any *"]:
    return _ffi.new(f"{type} *", object)


def get_address(value: "Any") -> Annotated[FFI.CData, "Any *"]:
...
def geo_to_gserialized(geom: BaseGeometry, geodetic: bool) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    if geodetic:
...
def geometry_to_gserialized(geom: BaseGeometry) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    text = wkt.dumps(geom)
    if get_srid(geom) > 0:
...
def geography_to_gserialized(geom: BaseGeometry) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    text = wkt.dumps(geom)
    if get_srid(geom) > 0:
        text = f"SRID={get_srid(geom)};{text}"
    gs = geog_in(text, -1)
...
def as_tinstant(temporal: Annotated[FFI.CData, "Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    return _ffi.cast("TInstant *", temporal)


def as_tsequence(temporal: Annotated[FFI.CData, "Temporal *"]) -> Annotated[FFI.CData, "TSequence *"]:
    return _ffi.cast("TSequence *", temporal)


def as_tsequenceset(temporal: Annotated[FFI.CData, "Temporal *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
...
def interval_cmp(
    interv1: Annotated[FFI.CData, "const Interval *"], interv2: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[int, "int"]:
...
def interval_in(string: str, typmod: int) -> Annotated[FFI.CData, "Interval *"]:
    string_converted = string.encode("utf-8")
...
def interval_out(interv: Annotated[FFI.CData, "const Interval *"]) -> Annotated[str, "char *"]:
...
def time_in(string: str, typmod: int) -> Annotated[FFI.CData, "TimeADT"]:
    string_converted = string.encode("utf-8")
    typmod_converted = _ffi.cast("int32", typmod)
...
def time_out(t: Annotated[FFI.CData, "TimeADT"]) -> Annotated[str, "char *"]:
...
def rtree_create_intspan() -> Annotated[FFI.CData, "RTree *"]:
    result = _lib.rtree_create_intspan()
    _check_error()
    return result if result != _ffi.NULL else None


def rtree_create_bigintspan() -> Annotated[FFI.CData, "RTree *"]:
    result = _lib.rtree_create_bigintspan()
    _check_error()
    return result if result != _ffi.NULL else None


def rtree_create_floatspan() -> Annotated[FFI.CData, "RTree *"]:
    result = _lib.rtree_create_floatspan()
    _check_error()
    return result if result != _ffi.NULL else None


def rtree_create_datespan() -> Annotated[FFI.CData, "RTree *"]:
    result = _lib.rtree_create_datespan()
    _check_error()
    return result if result != _ffi.NULL else None


def rtree_create_tstzspan() -> Annotated[FFI.CData, "RTree *"]:
    result = _lib.rtree_create_tstzspan()
    _check_error()
    return result if result != _ffi.NULL else None


def rtree_create_tbox() -> Annotated[FFI.CData, "RTree *"]:
    result = _lib.rtree_create_tbox()
    _check_error()
    return result if result != _ffi.NULL else None


def rtree_create_stbox() -> Annotated[FFI.CData, "RTree *"]:
    result = _lib.rtree_create_stbox()
    _check_error()
    return result if result != _ffi.NULL else None


def rtree_free(rtree: Annotated[FFI.CData, "RTree *"]) -> Annotated[None, "void"]:
...
def rtree_insert(
    rtree: Annotated[FFI.CData, "RTree *"], box: Annotated[FFI.CData, "void *"], id: int
) -> Annotated[None, "void"]:
    rtree_converted = _ffi.cast("RTree *", rtree)
...
def rtree_search(
    rtree: Annotated[FFI.CData, "const RTree *"],
    query: Annotated[FFI.CData, "const void *"],
    count: Annotated[FFI.CData, "int *"],
) -> Annotated[FFI.CData, "int *"]:
...
def meos_set_datestyle(newval: str, extra: Annotated[FFI.CData, "void *"]) -> Annotated[bool, "bool"]:
...
def meos_set_spatial_ref_sys_csv(path: Annotated[FFI.CData, "const char*"]) -> Annotated[None, "void"]:
...
def add_timestamptz_interval(t: int, interv: Annotated[FFI.CData, "const Interval *"]) -> Annotated[int, "TimestampTz"]:
    t_converted = _ffi.cast("TimestampTz", t)
    interv_converted = _ffi.cast("const Interval *", interv)
...
def minus_date_date(d1: int, d2: int) -> Annotated[FFI.CData, "Interval *"]:
...
def minus_timestamptz_interval(
    t: int, interv: Annotated[FFI.CData, "const Interval *"]
...
def minus_timestamptz_timestamptz(t1: int, t2: int) -> Annotated[FFI.CData, "Interval *"]:
...
def mul_interval_double(
    interv: Annotated[FFI.CData, "const Interval *"], factor: float
) -> Annotated[FFI.CData, "Interval *"]:
    interv_converted = _ffi.cast("const Interval *", interv)
...
def pg_interval_in(string: str, typmod: int) -> Annotated[FFI.CData, "Interval *"]:
    string_converted = string.encode("utf-8")
    typmod_converted = _ffi.cast("int32", typmod)
...
def pg_interval_out(interv: Annotated[FFI.CData, "const Interval *"]) -> Annotated[str, "char *"]:
    interv_converted = _ffi.cast("const Interval *", interv)
...
def timestamptz_shift(t: int, interv: Annotated[FFI.CData, "const Interval *"]) -> Annotated[int, "TimestampTz"]:
    t_converted = _ffi.cast("TimestampTz", t)
    interv_converted = _ffi.cast("const Interval *", interv)
...
def bigintset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def bigintset_out(set: Annotated[FFI.CData, "const Set *"]) -> Annotated[str, "char *"]:
...
def bigintspan_in(string: str) -> Annotated[FFI.CData, "Span *"]:
    string_converted = string.encode("utf-8")
...
def bigintspan_out(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[str, "char *"]:
...
def bigintspanset_in(string: str) -> Annotated[FFI.CData, "SpanSet *"]:
    string_converted = string.encode("utf-8")
...
def bigintspanset_out(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[str, "char *"]:
...
def dateset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def dateset_out(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[str, "char *"]:
...
def datespan_in(string: str) -> Annotated[FFI.CData, "Span *"]:
    string_converted = string.encode("utf-8")
...
def datespan_out(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def datespanset_in(string: str) -> Annotated[FFI.CData, "SpanSet *"]:
    string_converted = string.encode("utf-8")
...
def datespanset_out(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[str, "char *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def floatset_out(set: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[str, "char *"]:
    set_converted = _ffi.cast("const Set *", set)
...
def floatspan_in(string: str) -> Annotated[FFI.CData, "Span *"]:
    string_converted = string.encode("utf-8")
...
def floatspan_out(s: Annotated[FFI.CData, "const Span *"], maxdd: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspanset_in(string: str) -> Annotated[FFI.CData, "SpanSet *"]:
    string_converted = string.encode("utf-8")
...
def floatspanset_out(ss: Annotated[FFI.CData, "const SpanSet *"], maxdd: int) -> Annotated[str, "char *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def intset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def intset_out(set: Annotated[FFI.CData, "const Set *"]) -> Annotated[str, "char *"]:
    set_converted = _ffi.cast("const Set *", set)
...
def intspan_in(string: str) -> Annotated[FFI.CData, "Span *"]:
    string_converted = string.encode("utf-8")
...
def intspan_out(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def intspanset_in(string: str) -> Annotated[FFI.CData, "SpanSet *"]:
    string_converted = string.encode("utf-8")
...
def intspanset_out(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[str, "char *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def set_as_hexwkb(s: Annotated[FFI.CData, "const Set *"], variant: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_as_wkb(s: Annotated[FFI.CData, "const Set *"], variant: int) -> bytes:
    s_converted = _ffi.cast("const Set *", s)
    variant_converted = _ffi.cast("uint8_t", variant)
...
def set_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "Set *"]:
...
def set_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "Set *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.set_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def span_as_hexwkb(s: Annotated[FFI.CData, "const Span *"], variant: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Span *", s)
    variant_converted = _ffi.cast("uint8_t", variant)
...
def span_as_wkb(s: Annotated[FFI.CData, "const Span *"], variant: int) -> bytes:
    s_converted = _ffi.cast("const Span *", s)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def span_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "Span *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def span_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "Span *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.span_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def spanset_as_hexwkb(ss: Annotated[FFI.CData, "const SpanSet *"], variant: int) -> Annotated[str, "char *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    variant_converted = _ffi.cast("uint8_t", variant)
...
def spanset_as_wkb(ss: Annotated[FFI.CData, "const SpanSet *"], variant: int) -> bytes:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def spanset_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "SpanSet *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def spanset_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "SpanSet *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.spanset_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def textset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def textset_out(set: Annotated[FFI.CData, "const Set *"]) -> Annotated[str, "char *"]:
    set_converted = _ffi.cast("const Set *", set)
...
def tstzset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def tstzset_out(set: Annotated[FFI.CData, "const Set *"]) -> Annotated[str, "char *"]:
    set_converted = _ffi.cast("const Set *", set)
...
def tstzspan_in(string: str) -> Annotated[FFI.CData, "Span *"]:
    string_converted = string.encode("utf-8")
...
def tstzspan_out(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspanset_in(string: str) -> Annotated[FFI.CData, "SpanSet *"]:
    string_converted = string.encode("utf-8")
...
def tstzspanset_out(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[str, "char *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def bigintset_make(values: "list[const int64]") -> Annotated[FFI.CData, "Set *"]:
...
def bigintspan_make(lower: int, upper: int, lower_inc: bool, upper_inc: bool) -> Annotated[FFI.CData, "Span *"]:
...
def dateset_make(values: "list[const DateADT]") -> Annotated[FFI.CData, "Set *"]:
...
def datespan_make(lower: int, upper: int, lower_inc: bool, upper_inc: bool) -> Annotated[FFI.CData, "Span *"]:
...
def floatset_make(values: "list[const double]") -> Annotated[FFI.CData, "Set *"]:
...
def floatspan_make(lower: float, upper: float, lower_inc: bool, upper_inc: bool) -> Annotated[FFI.CData, "Span *"]:
    result = _lib.floatspan_make(lower, upper, lower_inc, upper_inc)
    _check_error()
    return result if result != _ffi.NULL else None


def intset_make(values: "list[const int]") -> Annotated[FFI.CData, "Set *"]:
...
def intspan_make(lower: int, upper: int, lower_inc: bool, upper_inc: bool) -> Annotated[FFI.CData, "Span *"]:
    result = _lib.intspan_make(lower, upper, lower_inc, upper_inc)
    _check_error()
    return result if result != _ffi.NULL else None


def set_copy(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def span_copy(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def spanset_copy(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_make(spans: list[Annotated[FFI.CData, "Span *"]]) -> Annotated[FFI.CData, "SpanSet *"]:
...
def textset_make(values: list[str]) -> Annotated[FFI.CData, "Set *"]:
...
def tstzset_make(values: int, count: int) -> Annotated[FFI.CData, "Set *"]:
...
def tstzspan_make(lower: int, upper: int, lower_inc: bool, upper_inc: bool) -> Annotated[FFI.CData, "Span *"]:
...
def bigint_to_set(i: int) -> Annotated[FFI.CData, "Set *"]:
...
def bigint_to_span(i: int) -> Annotated[FFI.CData, "Span *"]:
    result = _lib.bigint_to_span(i)
    _check_error()
    return result if result != _ffi.NULL else None


def bigint_to_spanset(i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    result = _lib.bigint_to_spanset(i)
    _check_error()
    return result if result != _ffi.NULL else None


def date_to_set(d: int) -> Annotated[FFI.CData, "Set *"]:
    d_converted = _ffi.cast("DateADT", d)
...
def date_to_span(d: int) -> Annotated[FFI.CData, "Span *"]:
    d_converted = _ffi.cast("DateADT", d)
...
def date_to_spanset(d: int) -> Annotated[FFI.CData, "SpanSet *"]:
    d_converted = _ffi.cast("DateADT", d)
...
def dateset_to_tstzset(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def datespan_to_tstzspan(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def datespanset_to_tstzspanset(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def float_to_set(d: float) -> Annotated[FFI.CData, "Set *"]:
    result = _lib.float_to_set(d)
    _check_error()
    return result if result != _ffi.NULL else None


def float_to_span(d: float) -> Annotated[FFI.CData, "Span *"]:
    result = _lib.float_to_span(d)
    _check_error()
    return result if result != _ffi.NULL else None


def float_to_spanset(d: float) -> Annotated[FFI.CData, "SpanSet *"]:
    result = _lib.float_to_spanset(d)
    _check_error()
    return result if result != _ffi.NULL else None


def floatset_to_intset(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatspan_to_intspan(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspanset_to_intspanset(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def int_to_set(i: int) -> Annotated[FFI.CData, "Set *"]:
    result = _lib.int_to_set(i)
    _check_error()
    return result if result != _ffi.NULL else None


def int_to_span(i: int) -> Annotated[FFI.CData, "Span *"]:
    result = _lib.int_to_span(i)
    _check_error()
    return result if result != _ffi.NULL else None


def int_to_spanset(i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    result = _lib.int_to_spanset(i)
    _check_error()
    return result if result != _ffi.NULL else None


def intset_to_floatset(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intspan_to_floatspan(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def intspanset_to_floatspanset(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def set_to_span(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_to_spanset(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def span_to_spanset(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def text_to_set(txt: str) -> Annotated[FFI.CData, "Set *"]:
    txt_converted = cstring2text(txt)
...
def timestamptz_to_set(t: int) -> Annotated[FFI.CData, "Set *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def timestamptz_to_span(t: int) -> Annotated[FFI.CData, "Span *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def timestamptz_to_spanset(t: int) -> Annotated[FFI.CData, "SpanSet *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def tstzset_to_dateset(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzspan_to_datespan(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspanset_to_datespanset(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def bigintset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "int64"]:
    s_converted = _ffi.cast("const Set *", s)
...
def bigintset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "int64"]:
    s_converted = _ffi.cast("const Set *", s)
...
def bigintset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[FFI.CData, "int64"]:
    s_converted = _ffi.cast("const Set *", s)
...
def bigintset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "int64 *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def bigintspan_lower(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "int64"]:
    s_converted = _ffi.cast("const Span *", s)
...
def bigintspan_upper(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "int64"]:
    s_converted = _ffi.cast("const Span *", s)
...
def bigintspan_width(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "int64"]:
    s_converted = _ffi.cast("const Span *", s)
...
def bigintspanset_lower(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int64"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def bigintspanset_upper(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int64"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def bigintspanset_width(ss: Annotated[FFI.CData, "const SpanSet *"], boundspan: bool) -> Annotated[int, "int64"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def dateset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "DateADT"]:
    s_converted = _ffi.cast("const Set *", s)
...
def dateset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "DateADT"]:
    s_converted = _ffi.cast("const Set *", s)
...
def dateset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[FFI.CData, "DateADT *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def dateset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "DateADT *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def datespan_duration(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Interval *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def datespan_lower(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "DateADT"]:
    s_converted = _ffi.cast("const Span *", s)
...
def datespan_upper(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "DateADT"]:
    s_converted = _ffi.cast("const Span *", s)
...
def datespanset_date_n(ss: Annotated[FFI.CData, "const SpanSet *"], n: int) -> Annotated[FFI.CData, "DateADT *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    out_result = _ffi.new("DateADT *")
...
def datespanset_dates(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Set *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def datespanset_duration(
    ss: Annotated[FFI.CData, "const SpanSet *"], boundspan: bool
) -> Annotated[FFI.CData, "Interval *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def datespanset_end_date(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "DateADT"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def datespanset_num_dates(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def datespanset_start_date(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "DateADT"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[FFI.CData, "double"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "double *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatspan_lower(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_upper(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_width(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspanset_lower(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatspanset_upper(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatspanset_width(ss: Annotated[FFI.CData, "const SpanSet *"], boundspan: bool) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def intset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[FFI.CData, "int"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "int *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intspan_lower(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Span *", s)
...
def intspan_upper(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Span *", s)
...
def intspan_width(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Span *", s)
...
def intspanset_lower(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def intspanset_upper(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def intspanset_width(ss: Annotated[FFI.CData, "const SpanSet *"], boundspan: bool) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def set_hash(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "uint32"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_hash_extended(s: Annotated[FFI.CData, "const Set *"], seed: int) -> Annotated[int, "uint64"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_num_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Set *", s)
...
def span_hash(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "uint32"]:
    s_converted = _ffi.cast("const Span *", s)
...
def span_hash_extended(s: Annotated[FFI.CData, "const Span *"], seed: int) -> Annotated[int, "uint64"]:
    s_converted = _ffi.cast("const Span *", s)
    seed_converted = _ffi.cast("uint64", seed)
...
def span_lower_inc(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def span_upper_inc(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def spanset_end_span(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_hash(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "uint32"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_hash_extended(ss: Annotated[FFI.CData, "const SpanSet *"], seed: int) -> Annotated[int, "uint64"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    seed_converted = _ffi.cast("uint64", seed)
...
def spanset_lower_inc(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_num_spans(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_span(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_span_n(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_spanarr(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Span **"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_start_span(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_upper_inc(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def textset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[str, "text *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def textset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[str, "text *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def textset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[list, "text **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def textset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "text **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "TimestampTz"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "TimestampTz"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> int:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "TimestampTz *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzspan_duration(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Interval *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspan_lower(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "TimestampTz"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspan_upper(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[int, "TimestampTz"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspanset_end_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "TimestampTz"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tstzspanset_lower(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "TimestampTz"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tstzspanset_num_timestamps(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tstzspanset_start_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "TimestampTz"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tstzspanset_timestamps(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Set *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tstzspanset_timestamptz_n(ss: Annotated[FFI.CData, "const SpanSet *"], n: int) -> int:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    out_result = _ffi.new("TimestampTz *")
...
def tstzspanset_upper(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "TimestampTz"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def bigintset_shift_scale(
    s: Annotated[FFI.CData, "const Set *"], shift: int, width: int, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def bigintspan_shift_scale(
    s: Annotated[FFI.CData, "const Span *"], shift: int, width: int, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    shift_converted = _ffi.cast("int64", shift)
    width_converted = _ffi.cast("int64", width)
...
def bigintspanset_shift_scale(
    ss: Annotated[FFI.CData, "const SpanSet *"], shift: int, width: int, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    shift_converted = _ffi.cast("int64", shift)
    width_converted = _ffi.cast("int64", width)
...
def floatset_ceil(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatset_degrees(s: Annotated[FFI.CData, "const Set *"], normalize: bool) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatset_floor(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatset_radians(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatset_shift_scale(
    s: Annotated[FFI.CData, "const Set *"], shift: float, width: float, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def floatspan_ceil(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_degrees(s: Annotated[FFI.CData, "const Span *"], normalize: bool) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_floor(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_radians(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_round(s: Annotated[FFI.CData, "const Span *"], maxdd: int) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_shift_scale(
    s: Annotated[FFI.CData, "const Span *"], shift: float, width: float, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspanset_ceil(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatspanset_floor(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatspanset_degrees(
    ss: Annotated[FFI.CData, "const SpanSet *"], normalize: bool
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatspanset_radians(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatspanset_round(ss: Annotated[FFI.CData, "const SpanSet *"], maxdd: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def floatspanset_shift_scale(
    ss: Annotated[FFI.CData, "const SpanSet *"], shift: float, width: float, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def numspan_expand(
    s: Annotated[FFI.CData, "const Span *"], value: Annotated[FFI.CData, "Datum"]
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspan_expand(
    s: Annotated[FFI.CData, "const Span *"], interv: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    interv_converted = _ffi.cast("const Interval *", interv)
...
def set_round(s: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def textcat_text_textset(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def textcat_textset_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def textset_initcap(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def textset_lower(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def textset_upper(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def timestamptz_tprecision(
    t: int, duration: Annotated[FFI.CData, "const Interval *"], torigin: int
) -> Annotated[int, "TimestampTz"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def tstzset_shift_scale(
    s: Annotated[FFI.CData, "const Set *"],
    shift: Annotated[FFI.CData, "const Interval *"] | None,
    duration: Annotated[FFI.CData, "const Interval *"] | None,
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzset_tprecision(
    s: Annotated[FFI.CData, "const Set *"], duration: Annotated[FFI.CData, "const Interval *"], torigin: int
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    duration_converted = _ffi.cast("const Interval *", duration)
    torigin_converted = _ffi.cast("TimestampTz", torigin)
...
def tstzspan_shift_scale(
    s: Annotated[FFI.CData, "const Span *"],
    shift: Annotated[FFI.CData, "const Interval *"] | None,
    duration: Annotated[FFI.CData, "const Interval *"] | None,
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspan_tprecision(
    s: Annotated[FFI.CData, "const Span *"], duration: Annotated[FFI.CData, "const Interval *"], torigin: int
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    duration_converted = _ffi.cast("const Interval *", duration)
    torigin_converted = _ffi.cast("TimestampTz", torigin)
...
def tstzspanset_shift_scale(
    ss: Annotated[FFI.CData, "const SpanSet *"],
    shift: Annotated[FFI.CData, "const Interval *"] | None,
    duration: Annotated[FFI.CData, "const Interval *"] | None,
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tstzspanset_tprecision(
    ss: Annotated[FFI.CData, "const SpanSet *"], duration: Annotated[FFI.CData, "const Interval *"], torigin: int
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    duration_converted = _ffi.cast("const Interval *", duration)
    torigin_converted = _ffi.cast("TimestampTz", torigin)
...
def set_cmp(s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "int"]:
...
def set_eq(s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s1_converted = _ffi.cast("const Set *", s1)
    s2_converted = _ffi.cast("const Set *", s2)
...
def set_ge(s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s1_converted = _ffi.cast("const Set *", s1)
    s2_converted = _ffi.cast("const Set *", s2)
...
def set_gt(s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s1_converted = _ffi.cast("const Set *", s1)
    s2_converted = _ffi.cast("const Set *", s2)
...
def set_le(s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s1_converted = _ffi.cast("const Set *", s1)
    s2_converted = _ffi.cast("const Set *", s2)
...
def set_lt(s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s1_converted = _ffi.cast("const Set *", s1)
    s2_converted = _ffi.cast("const Set *", s2)
...
def set_ne(s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s1_converted = _ffi.cast("const Set *", s1)
    s2_converted = _ffi.cast("const Set *", s2)
...
def span_cmp(
    s1: Annotated[FFI.CData, "const Span *"], s2: Annotated[FFI.CData, "const Span *"]
) -> Annotated[int, "int"]:
...
def spanset_cmp(
    ss1: Annotated[FFI.CData, "const SpanSet *"], ss2: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[int, "int"]:
...
def set_spans(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_split_each_n_spans(
    s: Annotated[FFI.CData, "const Set *"], elems_per_span: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Set *", s)
    count_converted = _ffi.cast("int *", count)
...
def set_split_n_spans(
    s: Annotated[FFI.CData, "const Set *"], span_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Set *", s)
    count_converted = _ffi.cast("int *", count)
...
def spanset_spans(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_split_each_n_spans(
    ss: Annotated[FFI.CData, "const SpanSet *"], elems_per_span: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    count_converted = _ffi.cast("int *", count)
...
def spanset_split_n_spans(
    ss: Annotated[FFI.CData, "const SpanSet *"], span_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    count_converted = _ffi.cast("int *", count)
...
def adjacent_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def adjacent_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def adjacent_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def adjacent_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def adjacent_span_spanset(
    s: Annotated[FFI.CData, "const Span *"], ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def adjacent_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def adjacent_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def adjacent_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def adjacent_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def adjacent_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def adjacent_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def adjacent_spanset_span(
    ss: Annotated[FFI.CData, "const SpanSet *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    s_converted = _ffi.cast("const Span *", s)
...
def contained_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def contained_bigint_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Span *", s)
...
def contained_bigint_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contained_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def contained_date_span(d: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Span *", s)
...
def contained_date_spanset(d: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contained_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contained_float_span(d: float, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def contained_float_spanset(d: float, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contained_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contained_int_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def contained_int_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contained_set_set(
    s1: Annotated[FFI.CData, "const Set *"], s2: Annotated[FFI.CData, "const Set *"]
) -> Annotated[bool, "bool"]:
    s1_converted = _ffi.cast("const Set *", s1)
    s2_converted = _ffi.cast("const Set *", s2)
...
def contained_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def contained_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def contained_timestamptz_span(t: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Span *", s)
...
def contained_timestamptz_spanset(t: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contains_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def contains_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def contains_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contains_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contains_set_text(s: Annotated[FFI.CData, "const Set *"], t: str) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contains_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def contains_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def contains_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def contains_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def contains_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def contains_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def contains_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def contains_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def contains_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contains_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contains_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def after_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def after_date_span(d: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Span *", s)
...
def after_date_spanset(d: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def after_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def after_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def after_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def after_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def after_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def after_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def after_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def after_timestamptz_span(t: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Span *", s)
...
def after_timestamptz_spanset(t: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def before_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def before_date_span(d: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Span *", s)
...
def before_date_spanset(d: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def before_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def before_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def before_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def before_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def before_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def before_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def before_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def before_timestamptz_span(t: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Span *", s)
...
def before_timestamptz_spanset(t: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def left_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def left_bigint_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Span *", s)
...
def left_bigint_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def left_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def left_float_span(d: float, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def left_float_spanset(d: float, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def left_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def left_int_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def left_int_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def left_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def left_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def left_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def left_set_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def left_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def left_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def left_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def left_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def left_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def left_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def left_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def overafter_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def overafter_date_span(d: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Span *", s)
...
def overafter_date_spanset(d: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overafter_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def overafter_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def overafter_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def overafter_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def overafter_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def overafter_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def overafter_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def overafter_timestamptz_span(t: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Span *", s)
...
def overafter_timestamptz_spanset(t: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overbefore_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def overbefore_date_span(d: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Span *", s)
...
def overbefore_date_spanset(d: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("DateADT", d)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overbefore_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def overbefore_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def overbefore_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def overbefore_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def overbefore_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def overbefore_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def overbefore_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def overbefore_timestamptz_span(t: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Span *", s)
...
def overbefore_timestamptz_spanset(t: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    t_converted = _ffi.cast("TimestampTz", t)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overleft_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def overleft_bigint_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Span *", s)
...
def overleft_bigint_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overleft_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overleft_float_span(d: float, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overleft_float_spanset(d: float, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overleft_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overleft_int_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overleft_int_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overleft_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def overleft_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overleft_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overleft_set_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def overleft_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def overleft_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overleft_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overleft_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def overleft_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overleft_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overleft_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def overright_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def overright_bigint_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Span *", s)
...
def overright_bigint_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overright_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overright_float_span(d: float, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overright_float_spanset(d: float, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overright_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overright_int_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overright_int_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overright_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def overright_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overright_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def overright_set_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def overright_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def overright_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overright_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def overright_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def overright_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overright_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def overright_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def right_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def right_bigint_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Span *", s)
...
def right_bigint_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    i_converted = _ffi.cast("int64", i)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def right_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def right_float_span(d: float, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def right_float_spanset(d: float, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def right_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def right_int_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def right_int_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def right_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def right_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def right_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def right_set_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def right_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def right_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def right_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
...
def right_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def right_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def right_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def right_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[bool, "bool"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def intersection_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def intersection_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_set_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def intersection_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def intersection_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def intersection_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def intersection_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def intersection_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def intersection_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def intersection_spanset_bigint(
    ss: Annotated[FFI.CData, "const SpanSet *"], i: int
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def intersection_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def intersection_spanset_float(
    ss: Annotated[FFI.CData, "const SpanSet *"], d: float
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def intersection_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def intersection_spanset_timestamptz(
    ss: Annotated[FFI.CData, "const SpanSet *"], t: int
) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def intersection_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def minus_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def minus_bigint_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Span *", s)
...
def minus_bigint_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    i_converted = _ffi.cast("int64", i)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def minus_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def minus_date_span(d: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Span *", s)
...
def minus_date_spanset(d: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    d_converted = _ffi.cast("DateADT", d)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def minus_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def minus_float_span(d: float, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def minus_float_spanset(d: float, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def minus_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def minus_int_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def minus_int_spanset(i: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def minus_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def minus_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def minus_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def minus_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def minus_set_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def minus_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def minus_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def minus_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def minus_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def minus_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def minus_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def minus_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def minus_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def minus_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def minus_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def minus_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def minus_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def minus_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def minus_timestamptz_span(t: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Span *", s)
...
def minus_timestamptz_spanset(t: int, ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    t_converted = _ffi.cast("TimestampTz", t)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def union_bigint_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    i_converted = _ffi.cast("int64", i)
    s_converted = _ffi.cast("const Set *", s)
...
def union_bigint_span(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def union_bigint_spanset(i: int, ss: Annotated[FFI.CData, "SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    i_converted = _ffi.cast("int64", i)
...
def union_date_set(d: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    d_converted = _ffi.cast("DateADT", d)
    s_converted = _ffi.cast("const Set *", s)
...
def union_date_span(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def union_date_spanset(d: int, ss: Annotated[FFI.CData, "SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    d_converted = _ffi.cast("DateADT", d)
    ss_converted = _ffi.cast("SpanSet *", ss)
...
def union_float_set(d: float, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def union_float_span(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def union_float_spanset(d: float, ss: Annotated[FFI.CData, "SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("SpanSet *", ss)
...
def union_int_set(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def union_int_span(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def union_int_spanset(i: int, ss: Annotated[FFI.CData, "SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("SpanSet *", ss)
...
def union_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def union_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def union_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def union_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def union_set_text(s: Annotated[FFI.CData, "const Set *"], txt: str) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def union_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def union_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def union_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def union_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def union_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def union_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def union_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def union_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def union_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def union_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def union_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def union_text_set(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def union_timestamptz_set(t: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Set *", s)
...
def union_timestamptz_span(t: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    t_converted = _ffi.cast("TimestampTz", t)
    s_converted = _ffi.cast("const Span *", s)
...
def union_timestamptz_spanset(t: int, ss: Annotated[FFI.CData, "SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    t_converted = _ffi.cast("TimestampTz", t)
    ss_converted = _ffi.cast("SpanSet *", ss)
...
def distance_set_bigint(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[int, "int64"]:
    s_converted = _ffi.cast("const Set *", s)
    i_converted = _ffi.cast("int64", i)
...
def distance_set_date(s: Annotated[FFI.CData, "const Set *"], d: int) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Set *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def distance_set_float(s: Annotated[FFI.CData, "const Set *"], d: float) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Set *", s)
...
def distance_set_int(s: Annotated[FFI.CData, "const Set *"], i: int) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Set *", s)
...
def distance_set_timestamptz(s: Annotated[FFI.CData, "const Set *"], t: int) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Set *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def distance_span_bigint(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[int, "int64"]:
    s_converted = _ffi.cast("const Span *", s)
    i_converted = _ffi.cast("int64", i)
...
def distance_span_date(s: Annotated[FFI.CData, "const Span *"], d: int) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Span *", s)
    d_converted = _ffi.cast("DateADT", d)
...
def distance_span_float(s: Annotated[FFI.CData, "const Span *"], d: float) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Span *", s)
...
def distance_span_int(s: Annotated[FFI.CData, "const Span *"], i: int) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Span *", s)
...
def distance_span_timestamptz(s: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[float, "double"]:
    s_converted = _ffi.cast("const Span *", s)
    t_converted = _ffi.cast("TimestampTz", t)
...
def distance_spanset_bigint(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[int, "int64"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    i_converted = _ffi.cast("int64", i)
...
def distance_spanset_date(ss: Annotated[FFI.CData, "const SpanSet *"], d: int) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    d_converted = _ffi.cast("DateADT", d)
...
def distance_spanset_float(ss: Annotated[FFI.CData, "const SpanSet *"], d: float) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def distance_spanset_int(ss: Annotated[FFI.CData, "const SpanSet *"], i: int) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def distance_spanset_timestamptz(ss: Annotated[FFI.CData, "const SpanSet *"], t: int) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def bigint_extent_transfn(state: Annotated[FFI.CData, "Span *"], i: int) -> Annotated[FFI.CData, "Span *"]:
...
def bigint_union_transfn(state: Annotated[FFI.CData, "Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
...
def date_extent_transfn(state: Annotated[FFI.CData, "Span *"], d: int) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
    d_converted = _ffi.cast("DateADT", d)
...
def date_union_transfn(state: Annotated[FFI.CData, "Set *"], d: int) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
    d_converted = _ffi.cast("DateADT", d)
...
def float_extent_transfn(state: Annotated[FFI.CData, "Span *"], d: float) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
...
def float_union_transfn(state: Annotated[FFI.CData, "Set *"], d: float) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
...
def int_extent_transfn(state: Annotated[FFI.CData, "Span *"], i: int) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
...
def int_union_transfn(state: Annotated[FFI.CData, "Set *"], i: int) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
...
def set_extent_transfn(
    state: Annotated[FFI.CData, "Span *"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
    s_converted = _ffi.cast("const Set *", s)
...
def set_union_finalfn(state: Annotated[FFI.CData, "Set *"]) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
...
def set_union_transfn(
    state: Annotated[FFI.CData, "Set *"], s: Annotated[FFI.CData, "Set *"]
) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
...
def span_extent_transfn(
    state: Annotated[FFI.CData, "Span *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
    s_converted = _ffi.cast("const Span *", s)
...
def span_union_transfn(
    state: Annotated[FFI.CData, "SpanSet *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "SpanSet *"]:
...
def spanset_extent_transfn(
    state: Annotated[FFI.CData, "Span *"], ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_union_finalfn(state: Annotated[FFI.CData, "SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    state_converted = _ffi.cast("SpanSet *", state)
...
def spanset_union_transfn(
    state: Annotated[FFI.CData, "SpanSet *"], ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "SpanSet *"]:
    state_converted = _ffi.cast("SpanSet *", state)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def text_union_transfn(state: Annotated[FFI.CData, "Set *"], txt: str) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
    txt_converted = cstring2text(txt)
...
def timestamptz_extent_transfn(state: Annotated[FFI.CData, "Span *"], t: int) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
    t_converted = _ffi.cast("TimestampTz", t)
...
def timestamptz_union_transfn(state: Annotated[FFI.CData, "Set *"], t: int) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
    t_converted = _ffi.cast("TimestampTz", t)
...
def bigintspan_bins(
    s: Annotated[FFI.CData, "const Span *"], vsize: int, vorigin: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    vsize_converted = _ffi.cast("int64", vsize)
    vorigin_converted = _ffi.cast("int64", vorigin)
...
def bigintspanset_bins(
    ss: Annotated[FFI.CData, "const SpanSet *"], vsize: int, vorigin: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    vsize_converted = _ffi.cast("int64", vsize)
    vorigin_converted = _ffi.cast("int64", vorigin)
...
def date_get_bin(d: int, duration: Annotated[FFI.CData, "const Interval *"], torigin: int) -> Annotated[int, "DateADT"]:
    d_converted = _ffi.cast("DateADT", d)
    duration_converted = _ffi.cast("const Interval *", duration)
...
def datespan_bins(
    s: Annotated[FFI.CData, "const Span *"],
    duration: Annotated[FFI.CData, "const Interval *"],
    torigin: int,
    count: Annotated[FFI.CData, "int *"],
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def floatspan_bins(
    s: Annotated[FFI.CData, "const Span *"], vsize: float, vorigin: float, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    count_converted = _ffi.cast("int *", count)
...
def floatspanset_bins(
    ss: Annotated[FFI.CData, "const SpanSet *"], vsize: float, vorigin: float, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    count_converted = _ffi.cast("int *", count)
...
def tbox_as_hexwkb(box: Annotated[FFI.CData, "const TBox *"], variant: int) -> Annotated[str, "char *"]:
...
def tbox_as_wkb(box: Annotated[FFI.CData, "const TBox *"], variant: int) -> bytes:
    box_converted = _ffi.cast("const TBox *", box)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def tbox_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "TBox *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def tbox_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "TBOX *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.tbox_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def tbox_in(string: str) -> Annotated[FFI.CData, "TBox *"]:
    string_converted = string.encode("utf-8")
...
def tbox_out(box: Annotated[FFI.CData, "const TBox *"], maxdd: int) -> Annotated[str, "char *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def float_timestamptz_to_tbox(d: float, t: int) -> Annotated[FFI.CData, "TBox *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def float_tstzspan_to_tbox(d: float, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "TBox *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def int_timestamptz_to_tbox(i: int, t: int) -> Annotated[FFI.CData, "TBox *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def int_tstzspan_to_tbox(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "TBox *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def numspan_tstzspan_to_tbox(
    span: Annotated[FFI.CData, "const Span *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "TBox *"]:
...
def numspan_timestamptz_to_tbox(span: Annotated[FFI.CData, "const Span *"], t: int) -> Annotated[FFI.CData, "TBox *"]:
    span_converted = _ffi.cast("const Span *", span)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tbox_copy(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_make(
    s: Annotated[FFI.CData, "const Span *"] | None, p: Annotated[FFI.CData, "const Span *"] | None
) -> Annotated[FFI.CData, "TBox *"]:
...
def float_to_tbox(d: float) -> Annotated[FFI.CData, "TBox *"]:
    result = _lib.float_to_tbox(d)
    _check_error()
    return result if result != _ffi.NULL else None


def int_to_tbox(i: int) -> Annotated[FFI.CData, "TBox *"]:
    result = _lib.int_to_tbox(i)
    _check_error()
    return result if result != _ffi.NULL else None


def set_to_tbox(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "TBox *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def span_to_tbox(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "TBox *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def spanset_to_tbox(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "TBox *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tbox_to_intspan(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "Span *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_to_floatspan(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "Span *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_to_tstzspan(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "Span *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def timestamptz_to_tbox(t: int) -> Annotated[FFI.CData, "TBox *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def tbox_hast(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_hasx(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_tmax(box: Annotated[FFI.CData, "const TBox *"]) -> int:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("TimestampTz *")
...
def tbox_tmax_inc(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "bool"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_tmin(box: Annotated[FFI.CData, "const TBox *"]) -> int:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("TimestampTz *")
...
def tbox_tmin_inc(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "bool"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("bool *")
...
def tbox_xmax(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("double *")
...
def tbox_xmax_inc(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "bool"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("bool *")
...
def tbox_xmin(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("double *")
...
def tbox_xmin_inc(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "bool"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("bool *")
...
def tboxfloat_xmax(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("double *")
...
def tboxfloat_xmin(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("double *")
...
def tboxint_xmax(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "int"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("int *")
...
def tboxint_xmin(box: Annotated[FFI.CData, "const TBox *"]) -> Annotated[FFI.CData, "int"]:
    box_converted = _ffi.cast("const TBox *", box)
    out_result = _ffi.new("int *")
...
def tbox_expand_float(box: Annotated[FFI.CData, "const TBox *"], d: float) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_expand_int(box: Annotated[FFI.CData, "const TBox *"], i: int) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_expand_time(
    box: Annotated[FFI.CData, "const TBox *"], interv: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
    interv_converted = _ffi.cast("const Interval *", interv)
...
def tbox_round(box: Annotated[FFI.CData, "const TBox *"], maxdd: int) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_shift_scale_float(
    box: Annotated[FFI.CData, "const TBox *"], shift: float, width: float, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_shift_scale_int(
    box: Annotated[FFI.CData, "const TBox *"], shift: int, width: int, hasshift: bool, haswidth: bool
) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def tbox_shift_scale_time(
    box: Annotated[FFI.CData, "const TBox *"],
    shift: Annotated[FFI.CData, "const Interval *"] | None,
    duration: Annotated[FFI.CData, "const Interval *"] | None,
) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
...
def union_tbox_tbox(
    box1: Annotated[FFI.CData, "const TBox *"], box2: Annotated[FFI.CData, "const TBox *"], strict: bool
) -> Annotated[FFI.CData, "TBox *"]:
...
def intersection_tbox_tbox(
    box1: Annotated[FFI.CData, "const TBox *"], box2: Annotated[FFI.CData, "const TBox *"]
) -> Annotated[FFI.CData, "TBox *"]:
    box1_converted = _ffi.cast("const TBox *", box1)
    box2_converted = _ffi.cast("const TBox *", box2)
...
def tbool_from_mfjson(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tbool_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tbool_out(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "char *"]:
...
def temporal_as_hexwkb(temp: Annotated[FFI.CData, "const Temporal *"], variant: int) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    variant_converted = _ffi.cast("uint8_t", variant)
...
def temporal_as_mfjson(
    temp: Annotated[FFI.CData, "const Temporal *"], with_bbox: bool, flags: int, precision: int, srs: str | None
) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_as_wkb(temp: Annotated[FFI.CData, "const Temporal *"], variant: int) -> bytes:
    temp_converted = _ffi.cast("const Temporal *", temp)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def temporal_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "Temporal *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def temporal_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "Temporal *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.temporal_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def tfloat_from_mfjson(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tfloat_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tfloat_out(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_from_mfjson(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tint_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tint_out(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_from_mfjson(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def ttext_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def ttext_out(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tbool_from_base_temp(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tboolinst_make(b: bool, t: int) -> Annotated[FFI.CData, "TInstant *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def tboolseq_from_base_tstzset(b: bool, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "TSequence *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tboolseq_from_base_tstzspan(
    b: bool, s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "TSequence *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tboolseqset_from_base_tstzspanset(
    b: bool, ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def temporal_copy(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_from_base_temp(
    d: float, temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloatinst_make(d: float, t: int) -> Annotated[FFI.CData, "TInstant *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def tfloatseq_from_base_tstzset(
    d: float, s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[FFI.CData, "TSequence *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tfloatseq_from_base_tstzspan(
    d: float, s: Annotated[FFI.CData, "const Span *"], interp: InterpolationType
) -> Annotated[FFI.CData, "TSequence *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tfloatseqset_from_base_tstzspanset(
    d: float, ss: Annotated[FFI.CData, "const SpanSet *"], interp: InterpolationType
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tint_from_base_temp(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tintinst_make(i: int, t: int) -> Annotated[FFI.CData, "TInstant *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def tintseq_from_base_tstzset(i: int, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "TSequence *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tintseq_from_base_tstzspan(i: int, s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "TSequence *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tintseqset_from_base_tstzspanset(
    i: int, ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tsequenceset_make_gaps(
    instants: Annotated[list, "const TInstant **"],
    interp: InterpolationType,
    maxt: Annotated[FFI.CData, "const Interval *"] | None,
    maxdist: float,
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    instants_converted = [_ffi.cast("const TInstant *", x) for x in instants]
...
def ttext_from_base_temp(
    txt: str, temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttextinst_make(txt: str, t: int) -> Annotated[FFI.CData, "TInstant *"]:
    txt_converted = cstring2text(txt)
    t_converted = _ffi.cast("TimestampTz", t)
...
def ttextseq_from_base_tstzset(txt: str, s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "TSequence *"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Set *", s)
...
def ttextseq_from_base_tstzspan(
    txt: str, s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "TSequence *"]:
    txt_converted = cstring2text(txt)
    s_converted = _ffi.cast("const Span *", s)
...
def ttextseqset_from_base_tstzspanset(
    txt: str, ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    txt_converted = cstring2text(txt)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tbool_to_tint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_to_tstzspan(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Span *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_to_tint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_to_tfloat(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_to_span(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Span *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_to_tbox(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TBox *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tbool_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[bool, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tbool_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[bool, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tbool_value_at_timestamptz(
    temp: Annotated[FFI.CData, "const Temporal *"], t: int, strict: bool
) -> Annotated[FFI.CData, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    t_converted = _ffi.cast("TimestampTz", t)
    out_result = _ffi.new("bool *")
...
def tbool_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[FFI.CData, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("bool *")
...
def tbool_values(
    temp: Annotated[FFI.CData, "const Temporal *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "bool *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def temporal_duration(
    temp: Annotated[FFI.CData, "const Temporal *"], boundspan: bool
) -> Annotated[FFI.CData, "Interval *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_end_instant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_end_sequence(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TSequence *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_end_timestamptz(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "TimestampTz"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_hash(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "uint32"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_instant_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_interp(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "const char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_lower_inc(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[bool, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_max_instant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_min_instant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_num_instants(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_num_sequences(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_num_timestamps(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_sequence_n(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "TSequence *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_start_instant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_start_sequence(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TSequence *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_start_timestamptz(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "TimestampTz"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_stops(
    temp: Annotated[FFI.CData, "const Temporal *"],
    maxdist: float,
    minduration: Annotated[FFI.CData, "const Interval *"],
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_subtype(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "const char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_time(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_timestamptz_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> int:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("TimestampTz *")
...
def temporal_upper_inc(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[bool, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_min_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_max_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[FFI.CData, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("double *")
...
def tint_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_max_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_min_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[FFI.CData, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("int *")
...
def tnumber_avg_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_integral(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_twavg(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_valuespans(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "text *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_max_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "text *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_min_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "text *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "text *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[list, "text **"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("text **")
...
def temporal_round(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_scale_time(
    temp: Annotated[FFI.CData, "const Temporal *"], duration: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    duration_converted = _ffi.cast("const Interval *", duration)
...
def temporal_set_interp(
    temp: Annotated[FFI.CData, "const Temporal *"], interp: InterpolationType
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_shift_time(
    temp: Annotated[FFI.CData, "const Temporal *"], shift: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_to_tinstant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_ceil(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_degrees(
    temp: Annotated[FFI.CData, "const Temporal *"], normalize: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_floor(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_radians(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_scale_value(
    temp: Annotated[FFI.CData, "const Temporal *"], width: float
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_shift_scale_value(
    temp: Annotated[FFI.CData, "const Temporal *"], shift: float, width: float
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_shift_value(
    temp: Annotated[FFI.CData, "const Temporal *"], shift: float
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_scale_value(temp: Annotated[FFI.CData, "const Temporal *"], width: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_shift_scale_value(
    temp: Annotated[FFI.CData, "const Temporal *"], shift: int, width: int
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_shift_value(temp: Annotated[FFI.CData, "const Temporal *"], shift: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_append_tinstant(
    temp: Annotated[FFI.CData, "Temporal *"],
    inst: Annotated[FFI.CData, "const TInstant *"],
    interp: InterpolationType,
    maxdist: float,
    maxt: Annotated[FFI.CData, "const Interval *"] | None,
    expand: bool,
...
def temporal_append_tsequence(
    temp: Annotated[FFI.CData, "Temporal *"], seq: Annotated[FFI.CData, "const TSequence *"], expand: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("Temporal *", temp)
...
def temporal_delete_timestamptz(
    temp: Annotated[FFI.CData, "const Temporal *"], t: int, connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    t_converted = _ffi.cast("TimestampTz", t)
...
def temporal_delete_tstzset(
    temp: Annotated[FFI.CData, "const Temporal *"], s: Annotated[FFI.CData, "const Set *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    s_converted = _ffi.cast("const Set *", s)
...
def temporal_delete_tstzspan(
    temp: Annotated[FFI.CData, "const Temporal *"], s: Annotated[FFI.CData, "const Span *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    s_converted = _ffi.cast("const Span *", s)
...
def temporal_delete_tstzspanset(
    temp: Annotated[FFI.CData, "const Temporal *"], ss: Annotated[FFI.CData, "const SpanSet *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def temporal_insert(
    temp1: Annotated[FFI.CData, "const Temporal *"], temp2: Annotated[FFI.CData, "const Temporal *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
...
def temporal_merge(
    temp1: Annotated[FFI.CData, "const Temporal *"], temp2: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp1_converted = _ffi.cast("const Temporal *", temp1)
    temp2_converted = _ffi.cast("const Temporal *", temp2)
...
def tbool_at_value(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tbool_minus_value(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_at_max(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_at_min(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_at_timestamptz(
    temp: Annotated[FFI.CData, "const Temporal *"], t: int
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    t_converted = _ffi.cast("TimestampTz", t)
...
def temporal_at_tstzset(
    temp: Annotated[FFI.CData, "const Temporal *"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    s_converted = _ffi.cast("const Set *", s)
...
def temporal_at_tstzspan(
    temp: Annotated[FFI.CData, "const Temporal *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    s_converted = _ffi.cast("const Span *", s)
...
def temporal_at_tstzspanset(
    temp: Annotated[FFI.CData, "const Temporal *"], ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def temporal_at_values(
    temp: Annotated[FFI.CData, "const Temporal *"], set: Annotated[FFI.CData, "const Set *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    set_converted = _ffi.cast("const Set *", set)
...
def temporal_minus_max(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_minus_min(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_at_value(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_minus_value(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_at_value(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tint_minus_value(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_at_span(
    temp: Annotated[FFI.CData, "const Temporal *"], span: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    span_converted = _ffi.cast("const Span *", span)
...
def tnumber_at_tbox(
    temp: Annotated[FFI.CData, "const Temporal *"], box: Annotated[FFI.CData, "const TBox *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    box_converted = _ffi.cast("const TBox *", box)
...
def ttext_at_value(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ttext_minus_value(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def always_eq_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def always_ge_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ge_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ge_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ge_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ge_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ge_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def always_gt_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_gt_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_gt_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_gt_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_gt_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_gt_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def always_le_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_le_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_le_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_le_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_le_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_le_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def always_lt_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_lt_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_lt_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_lt_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_lt_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_lt_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def always_ne_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ne_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ne_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ne_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ne_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ne_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ne_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_ne_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ever_eq_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_eq_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_eq_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_eq_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_eq_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_eq_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_eq_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_eq_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ever_ge_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ge_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ge_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ge_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ge_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ge_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ever_gt_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_gt_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_gt_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_gt_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_gt_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_gt_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ever_le_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_le_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_le_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_le_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_le_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_le_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ever_lt_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_lt_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_lt_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_lt_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_lt_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_lt_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ever_ne_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ne_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ne_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ne_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ne_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ne_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ne_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ever_ne_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def teq_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def teq_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def teq_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def teq_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def teq_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def teq_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def teq_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def teq_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def tge_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tge_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tge_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tge_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tge_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tge_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def tgt_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgt_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgt_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgt_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgt_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgt_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def tle_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tle_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tle_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tle_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tle_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tle_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def tlt_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tlt_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tlt_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tlt_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tlt_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tlt_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def tne_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tne_float_tfloat(d: float, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tne_int_tint(i: int, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tne_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tne_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tne_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tne_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tne_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def temporal_split_each_n_spans(
    temp: Annotated[FFI.CData, "const Temporal *"], elem_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def temporal_split_n_spans(
    temp: Annotated[FFI.CData, "const Temporal *"], span_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def tnumber_split_n_tboxes(
    temp: Annotated[FFI.CData, "const Temporal *"], box_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "TBox *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def adjacent_numspan_tnumber(
    s: Annotated[FFI.CData, "const Span *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Span *", s)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def adjacent_tbox_tnumber(
    box: Annotated[FFI.CData, "const TBox *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const TBox *", box)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tand_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tand_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tbool_when_true(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnot_tbool(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tor_bool_tbool(b: bool, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tor_tbool_bool(temp: Annotated[FFI.CData, "const Temporal *"], b: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def add_float_tfloat(d: float, tnumber: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
...
def add_int_tint(i: int, tnumber: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def add_tfloat_float(tnumber: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def add_tint_int(tnumber: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def add_tnumber_tnumber(
    tnumber1: Annotated[FFI.CData, "const Temporal *"], tnumber2: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
...
def div_float_tfloat(d: float, tnumber: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def div_int_tint(i: int, tnumber: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def div_tfloat_float(tnumber: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def div_tint_int(tnumber: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def mult_float_tfloat(
    d: float, tnumber: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def mult_int_tint(i: int, tnumber: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def mult_tfloat_float(
    tnumber: Annotated[FFI.CData, "const Temporal *"], d: float
) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def mult_tint_int(tnumber: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def sub_float_tfloat(d: float, tnumber: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def sub_int_tint(i: int, tnumber: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def sub_tfloat_float(tnumber: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def sub_tint_int(tnumber: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    tnumber_converted = _ffi.cast("const Temporal *", tnumber)
...
def temporal_derivative(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_exp(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_ln(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloat_log10(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_abs(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_angular_difference(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumber_delta_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def textcat_text_ttext(txt: str, temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    txt_converted = cstring2text(txt)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def textcat_ttext_text(temp: Annotated[FFI.CData, "const Temporal *"], txt: str) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    txt_converted = cstring2text(txt)
...
def ttext_initcap(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_upper(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def ttext_lower(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tdistance_tfloat_float(
    temp: Annotated[FFI.CData, "const Temporal *"], d: float
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tdistance_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def nad_tfloat_float(temp: Annotated[FFI.CData, "const Temporal *"], d: float) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def nad_tint_int(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tbool_tand_transfn(
    state: Annotated[FFI.CData, "SkipList *"] | None, temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "SkipList *"]:
...
def temporal_extent_transfn(
    s: Annotated[FFI.CData, "Span *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Span *"]:
...
def temporal_tagg_finalfn(state: Annotated[FFI.CData, "SkipList *"]) -> Annotated[FFI.CData, "Temporal *"]:
...
def tfloat_wmax_transfn(
    state: Annotated[FFI.CData, "SkipList *"],
    temp: Annotated[FFI.CData, "const Temporal *"],
    interv: Annotated[FFI.CData, "const Interval *"],
) -> Annotated[FFI.CData, "SkipList *"]:
    state_converted = _ffi.cast("SkipList *", state)
    temp_converted = _ffi.cast("const Temporal *", temp)
    interv_converted = _ffi.cast("const Interval *", interv)
...
def timestamptz_tcount_transfn(
    state: Annotated[FFI.CData, "SkipList *"] | None, t: int
) -> Annotated[FFI.CData, "SkipList *"]:
    state_converted = _ffi.cast("SkipList *", state) if state is not None else _ffi.NULL
    t_converted = _ffi.cast("TimestampTz", t)
...
def tnumber_extent_transfn(
    box: Annotated[FFI.CData, "TBox *"] | None, temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "TBox *"]:
...
def tnumber_tavg_finalfn(state: Annotated[FFI.CData, "SkipList *"]) -> Annotated[FFI.CData, "Temporal *"]:
    state_converted = _ffi.cast("SkipList *", state)
...
def tstzset_tcount_transfn(
    state: Annotated[FFI.CData, "SkipList *"] | None, s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[FFI.CData, "SkipList *"]:
    state_converted = _ffi.cast("SkipList *", state) if state is not None else _ffi.NULL
    s_converted = _ffi.cast("const Set *", s)
...
def tstzspan_tcount_transfn(
    state: Annotated[FFI.CData, "SkipList *"] | None, s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "SkipList *"]:
    state_converted = _ffi.cast("SkipList *", state) if state is not None else _ffi.NULL
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspanset_tcount_transfn(
    state: Annotated[FFI.CData, "SkipList *"] | None, ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "SkipList *"]:
    state_converted = _ffi.cast("SkipList *", state) if state is not None else _ffi.NULL
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def temporal_simplify_dp(
    temp: Annotated[FFI.CData, "const Temporal *"], eps_dist: float, synchronized: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_simplify_min_dist(
    temp: Annotated[FFI.CData, "const Temporal *"], dist: float
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_simplify_min_tdelta(
    temp: Annotated[FFI.CData, "const Temporal *"], mint: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_tprecision(
    temp: Annotated[FFI.CData, "const Temporal *"], duration: Annotated[FFI.CData, "const Interval *"], origin: int
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    duration_converted = _ffi.cast("const Interval *", duration)
    origin_converted = _ffi.cast("TimestampTz", origin)
...
def temporal_dyntimewarp_path(
    temp1: Annotated[FFI.CData, "const Temporal *"],
    temp2: Annotated[FFI.CData, "const Temporal *"],
    count: Annotated[FFI.CData, "int *"],
) -> Annotated[FFI.CData, "Match *"]:
    temp1_converted = _ffi.cast("const Temporal *", temp1)
    temp2_converted = _ffi.cast("const Temporal *", temp2)
    count_converted = _ffi.cast("int *", count)
...
def temporal_time_split(
    temp: Annotated[FFI.CData, "const Temporal *"], duration: Annotated[FFI.CData, "const Interval *"], torigin: int
) -> tuple[Annotated[FFI.CData, "Temporal **"], Annotated[list, "TimestampTz *"], Annotated[FFI.CData, "int"]]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    duration_converted = _ffi.cast("const Interval *", duration)
    torigin_converted = _ffi.cast("TimestampTz", torigin)
...
def tfloat_value_bins(
    temp: Annotated[FFI.CData, "const Temporal *"], vsize: float, vorigin: float, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def tfloat_value_split(
    temp: Annotated[FFI.CData, "const Temporal *"], size: float, origin: float
) -> tuple[Annotated[FFI.CData, "Temporal **"], Annotated[list, "double *"], Annotated[FFI.CData, "int"]]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloatbox_value_tiles(
    box: Annotated[FFI.CData, "const TBox *"], vsize: float, vorigin: float, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
    count_converted = _ffi.cast("int *", count)
...
def tfloatbox_value_time_tiles(
    ...
    vorigin: float,
    torigin: int | None,
) -> tuple[Annotated[FFI.CData, "TBox *"], Annotated[FFI.CData, "int"]]:
    box_converted = _ffi.cast("const TBox *", box)
    duration_converted = _ffi.cast("const Interval *", duration)
...
def tint_value_bins(
    temp: Annotated[FFI.CData, "const Temporal *"], vsize: int, vorigin: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "Span *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def tint_value_split(
    temp: Annotated[FFI.CData, "const Temporal *"], vsize: int, vorigin: int
) -> tuple[Annotated[FFI.CData, "Temporal **"], Annotated[list, "int *"], Annotated[FFI.CData, "int"]]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    bins = _ffi.new("int **")
    count = _ffi.new("int *")
...
def tintbox_value_tiles(
    box: Annotated[FFI.CData, "const TBox *"], xsize: int, xorigin: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
    count_converted = _ffi.cast("int *", count)
...
def geo_as_ewkb(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], endian: str, size: Annotated[FFI.CData, "size_t *"]
) -> Annotated[FFI.CData, "uint8_t *"]:
...
def geo_as_ewkt(gs: Annotated[FFI.CData, "const GSERIALIZED *"], precision: int) -> Annotated[str, "char *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_as_geojson(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], option: int, precision: int, srs: str | None
) -> Annotated[str, "char *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    srs_converted = srs.encode("utf-8") if srs is not None else _ffi.NULL
...
def geo_as_hexewkb(gs: Annotated[FFI.CData, "const GSERIALIZED *"], endian: str) -> Annotated[str, "char *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    endian_converted = endian.encode("utf-8")
...
def geo_as_text(gs: Annotated[FFI.CData, "const GSERIALIZED *"], precision: int) -> Annotated[str, "char *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_from_ewkb(
    wkb: Annotated[FFI.CData, "const uint8_t *"], wkb_size: Annotated[FFI.CData, "size_t"], srid: int
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geo_from_geojson(geojson: str) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geo_from_text(wkt: str, srid: Annotated[FFI.CData, "int32_t"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geo_out(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[str, "char *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geog_from_binary(wkb_bytea: str) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geog_from_hexewkb(wkt: str) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    wkt_converted = wkt.encode("utf-8")
...
def geog_in(string: str, typmod: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    string_converted = string.encode("utf-8")
    typmod_converted = _ffi.cast("int32", typmod)
...
def geom_from_hexewkb(wkt: str) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    wkt_converted = wkt.encode("utf-8")
...
def geom_in(string: str, typmod: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    string_converted = string.encode("utf-8")
    typmod_converted = _ffi.cast("int32", typmod)
...
def geo_copy(g: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geogpoint_make2d(
    srid: Annotated[FFI.CData, "int32_t"], x: float, y: float
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    srid_converted = _ffi.cast("int32_t", srid)
...
def geogpoint_make3dz(
    srid: Annotated[FFI.CData, "int32_t"], x: float, y: float, z: float
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    srid_converted = _ffi.cast("int32_t", srid)
...
def geom_to_geog(geom: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geog_to_geom(geog: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geo_is_empty(g: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[bool, "bool"]:
    g_converted = _ffi.cast("const GSERIALIZED *", g)
...
def geo_is_unitary(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[bool, "bool"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geog_area(g: Annotated[FFI.CData, "const GSERIALIZED *"], use_spheroid: bool) -> Annotated[float, "double"]:
    g_converted = _ffi.cast("const GSERIALIZED *", g)
...
def geog_centroid(
    g: Annotated[FFI.CData, "const GSERIALIZED *"], use_spheroid: bool
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    g_converted = _ffi.cast("const GSERIALIZED *", g)
...
def geog_length(g: Annotated[FFI.CData, "const GSERIALIZED *"], use_spheroid: bool) -> Annotated[float, "double"]:
    g_converted = _ffi.cast("const GSERIALIZED *", g)
...
def geog_perimeter(g: Annotated[FFI.CData, "const GSERIALIZED *"], use_spheroid: bool) -> Annotated[float, "double"]:
    g_converted = _ffi.cast("const GSERIALIZED *", g)
...
def geom_azimuth(
    gs1: Annotated[FFI.CData, "const GSERIALIZED *"], gs2: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[FFI.CData, "double"]:
...
def geom_length(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[float, "double"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geom_perimeter(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[float, "double"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def line_numpoints(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[int, "int"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def line_point_n(geom: Annotated[FFI.CData, "const GSERIALIZED *"], n: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    geom_converted = _ffi.cast("const GSERIALIZED *", geom)
...
def geo_reverse(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_round(gs: Annotated[FFI.CData, "const GSERIALIZED *"], maxdd: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_set_srid(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    srid_converted = _ffi.cast("int32_t", srid)
...
def geo_srid(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "int32_t"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_transform(
    geom: Annotated[FFI.CData, "GSERIALIZED *"], srid_to: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geo_transform_pipeline(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"],
    pipeline: str,
    srid_to: Annotated[FFI.CData, "int32_t"],
    is_forward: bool,
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_collect_garray(gsarr: Annotated[list, "GSERIALIZED **"], count: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geo_makeline_garray(gsarr: Annotated[list, "GSERIALIZED **"], count: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gsarr_converted = [_ffi.cast("GSERIALIZED *", x) for x in gsarr]
...
def geo_npoints(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[int, "int"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_ngeos(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[int, "int"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geo_geoN(geom: Annotated[FFI.CData, "const GSERIALIZED *"], n: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    geom_converted = _ffi.cast("const GSERIALIZED *", geom)
...
def geo_pointarr(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "GSERIALIZED **"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    count_converted = _ffi.cast("int *", count)
...
def geo_points(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geom_array_union(gsarr: Annotated[list, "GSERIALIZED **"], count: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gsarr_converted = [_ffi.cast("GSERIALIZED *", x) for x in gsarr]
...
def geom_boundary(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geom_buffer(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], size: float, params: str
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geom_centroid(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geom_convex_hull(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geom_min_bounding_radius(
    geom: Annotated[FFI.CData, "const GSERIALIZED *"], radius: Annotated[FFI.CData, "double *"]
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    geom_converted = _ffi.cast("const GSERIALIZED *", geom)
...
def geom_shortestline2d(
    gs1: Annotated[FFI.CData, "const GSERIALIZED *"], s2: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
...
def geom_unary_union(gs: Annotated[FFI.CData, "GSERIALIZED *"], prec: float) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def line_interpolate_point(
    gs: Annotated[FFI.CData, "GSERIALIZED *"], distance_fraction: float, repeat: bool
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("GSERIALIZED *", gs)
...
def line_substring(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], from_: float, to: float
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geog_dwithin(
    g1: Annotated[FFI.CData, "const GSERIALIZED *"],
    g2: Annotated[FFI.CData, "const GSERIALIZED *"],
    tolerance: float,
    use_spheroid: bool,
) -> Annotated[bool, "bool"]:
...
def geog_intersects(
    gs1: Annotated[FFI.CData, "const GSERIALIZED *"],
    gs2: Annotated[FFI.CData, "const GSERIALIZED *"],
    use_spheroid: bool,
) -> Annotated[bool, "bool"]:
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
    gs2_converted = _ffi.cast("const GSERIALIZED *", gs2)
...
def geom_dwithin2d(
    gs1: Annotated[FFI.CData, "const GSERIALIZED *"], gs2: Annotated[FFI.CData, "const GSERIALIZED *"], tolerance: float
) -> Annotated[bool, "bool"]:
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
    gs2_converted = _ffi.cast("const GSERIALIZED *", gs2)
...
def geom_relate_pattern(
    gs1: Annotated[FFI.CData, "const GSERIALIZED *"], gs2: Annotated[FFI.CData, "const GSERIALIZED *"], patt: str
) -> Annotated[bool, "bool"]:
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
    gs2_converted = _ffi.cast("const GSERIALIZED *", gs2)
...
def geo_split_each_n_stboxes(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], elem_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "STBox *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    count_converted = _ffi.cast("int *", count)
...
def geo_split_n_stboxes(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], box_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "STBox *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    count_converted = _ffi.cast("int *", count)
...
def geog_distance(
    g1: Annotated[FFI.CData, "const GSERIALIZED *"], g2: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[float, "double"]:
    g1_converted = _ffi.cast("const GSERIALIZED *", g1)
    g2_converted = _ffi.cast("const GSERIALIZED *", g2)
...
def geogset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def geomset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def spatialset_as_text(set: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[str, "char *"]:
    set_converted = _ffi.cast("const Set *", set)
...
def spatialset_as_ewkt(set: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[str, "char *"]:
    set_converted = _ffi.cast("const Set *", set)
...
def geoset_make(values: Annotated[list, "const GSERIALIZED **"]) -> Annotated[FFI.CData, "Set *"]:
...
def geo_to_set(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "Set *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geoset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def geoset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def geoset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[list, "GSERIALIZED **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def geoset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "GSERIALIZED **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contained_geo_set(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[bool, "bool"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    s_converted = _ffi.cast("const Set *", s)
...
def contains_set_geo(
    s: Annotated[FFI.CData, "const Set *"], gs: Annotated[FFI.CData, "GSERIALIZED *"]
) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    gs_converted = _ffi.cast("GSERIALIZED *", gs)
...
def geo_union_transfn(
    state: Annotated[FFI.CData, "Set *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def intersection_set_geo(
    s: Annotated[FFI.CData, "const Set *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def spatialset_set_srid(
    s: Annotated[FFI.CData, "const Set *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    srid_converted = _ffi.cast("int32_t", srid)
...
def spatialset_srid(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "int32_t"]:
    s_converted = _ffi.cast("const Set *", s)
...
def spatialset_transform_pipeline(
    s: Annotated[FFI.CData, "const Set *"], pipelinestr: str, srid: Annotated[FFI.CData, "int32_t"], is_forward: bool
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def stbox_as_hexwkb(box: Annotated[FFI.CData, "const STBox *"], variant: int) -> Annotated[str, "char *"]:
...
def stbox_as_wkb(box: Annotated[FFI.CData, "const STBox *"], variant: int) -> bytes:
    box_converted = _ffi.cast("const STBox *", box)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def stbox_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "STBox *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def stbox_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "STBOX *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.stbox_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def stbox_in(string: str) -> Annotated[FFI.CData, "STBox *"]:
    string_converted = string.encode("utf-8")
...
def stbox_out(box: Annotated[FFI.CData, "const STBox *"], maxdd: int) -> Annotated[str, "char *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def geo_timestamptz_to_stbox(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], t: int
) -> Annotated[FFI.CData, "STBox *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    t_converted = _ffi.cast("TimestampTz", t)
...
def geo_tstzspan_to_stbox(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "STBox *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    s_converted = _ffi.cast("const Span *", s)
...
def stbox_copy(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_make(
    ...
    zmin: float,
    zmax: float,
    s: Annotated[FFI.CData, "const Span *"] | None,
) -> Annotated[FFI.CData, "STBox *"]:
    srid_converted = _ffi.cast("int32", srid)
    s_converted = _ffi.cast("const Span *", s) if s is not None else _ffi.NULL
...
def geo_to_stbox(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "STBox *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def spatialset_to_stbox(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "STBox *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def stbox_to_box3d(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "BOX3D *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_to_gbox(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "GBOX *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_to_geo(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_to_tstzspan(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "Span *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def timestamptz_to_stbox(t: int) -> Annotated[FFI.CData, "STBox *"]:
    t_converted = _ffi.cast("TimestampTz", t)
...
def tstzset_to_stbox(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "STBox *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def tstzspan_to_stbox(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "STBox *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def tstzspanset_to_stbox(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "STBox *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def stbox_area(box: Annotated[FFI.CData, "const STBox *"], spheroid: bool) -> Annotated[float, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_hast(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_hasx(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_hasz(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_isgeodetic(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_perimeter(box: Annotated[FFI.CData, "const STBox *"], spheroid: bool) -> Annotated[float, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_tmax(box: Annotated[FFI.CData, "const STBox *"]) -> int:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("TimestampTz *")
...
def stbox_tmax_inc(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "bool"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("bool *")
...
def stbox_tmin(box: Annotated[FFI.CData, "const STBox *"]) -> int:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("TimestampTz *")
...
def stbox_tmin_inc(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "bool"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("bool *")
...
def stbox_volume(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[float, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_xmax(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("double *")
...
def stbox_xmin(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("double *")
...
def stbox_ymax(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("double *")
...
def stbox_ymin(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("double *")
...
def stbox_zmax(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("double *")
...
def stbox_zmin(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
    out_result = _ffi.new("double *")
...
def stbox_expand_space(box: Annotated[FFI.CData, "const STBox *"], d: float) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_expand_time(
    box: Annotated[FFI.CData, "const STBox *"], interv: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
    interv_converted = _ffi.cast("const Interval *", interv)
...
def stbox_get_space(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_quad_split(
    box: Annotated[FFI.CData, "const STBox *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
    count_converted = _ffi.cast("int *", count)
...
def stbox_round(box: Annotated[FFI.CData, "const STBox *"], maxdd: int) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_shift_scale_time(
    box: Annotated[FFI.CData, "const STBox *"],
    shift: Annotated[FFI.CData, "const Interval *"] | None,
    duration: Annotated[FFI.CData, "const Interval *"] | None,
) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stboxarr_round(
    boxarr: Annotated[FFI.CData, "const STBox *"], count: int, maxdd: int
) -> Annotated[FFI.CData, "STBox *"]:
...
def stbox_set_srid(
    box: Annotated[FFI.CData, "const STBox *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
    srid_converted = _ffi.cast("int32_t", srid)
...
def stbox_srid(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "int32_t"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_transform_pipeline(
    box: Annotated[FFI.CData, "const STBox *"],
    pipelinestr: str,
    srid: Annotated[FFI.CData, "int32_t"],
    is_forward: bool,
) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const STBox *", box)
    pipelinestr_converted = pipelinestr.encode("utf-8")
...
def adjacent_stbox_stbox(
    box1: Annotated[FFI.CData, "const STBox *"], box2: Annotated[FFI.CData, "const STBox *"]
) -> Annotated[bool, "bool"]:
...
def union_stbox_stbox(
    box1: Annotated[FFI.CData, "const STBox *"], box2: Annotated[FFI.CData, "const STBox *"], strict: bool
) -> Annotated[FFI.CData, "STBox *"]:
    box1_converted = _ffi.cast("const STBox *", box1)
    box2_converted = _ffi.cast("const STBox *", box2)
...
def tgeo_out(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeogpoint_from_mfjson(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tgeogpoint_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tgeography_from_mfjson(mfjson: str) -> Annotated[FFI.CData, "Temporal *"]:
...
def tgeography_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tgeometry_from_mfjson(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tgeometry_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tgeompoint_from_mfjson(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tgeompoint_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tspatial_as_ewkt(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tspatial_as_text(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_from_base_temp(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeoinst_make(gs: Annotated[FFI.CData, "const GSERIALIZED *"], t: int) -> Annotated[FFI.CData, "TInstant *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tgeoseq_from_base_tstzspan(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], s: Annotated[FFI.CData, "const Span *"], interp: InterpolationType
) -> Annotated[FFI.CData, "TSequence *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    s_converted = _ffi.cast("const Span *", s)
...
def tpointinst_make(gs: Annotated[FFI.CData, "const GSERIALIZED *"], t: int) -> Annotated[FFI.CData, "TInstant *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tpointseq_make_coords(
    xcoords: Annotated[FFI.CData, "const double *"],
    ycoords: Annotated[FFI.CData, "const double *"],
    zcoords: Annotated[FFI.CData, "const double *"],
    times: int,
    count: int,
    srid: int,
    geodetic: bool,
...
def box3d_to_stbox(box: Annotated[FFI.CData, "const BOX3D *"]) -> Annotated[FFI.CData, "STBox *"]:
...
def gbox_to_stbox(box: Annotated[FFI.CData, "const GBOX *"]) -> Annotated[FFI.CData, "STBox *"]:
...
def geomeas_to_tpoint(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "Temporal *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def tgeogpoint_to_tgeography(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeography_to_tgeogpoint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeography_to_tgeometry(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeometry_to_tgeography(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeometry_to_tgeompoint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeompoint_to_tgeometry(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_as_mvtgeom(
    temp: Annotated[FFI.CData, "const Temporal *"],
    bounds: Annotated[FFI.CData, "const STBox *"],
    extent: Annotated[FFI.CData, "int32_t"],
    buffer: Annotated[FFI.CData, "int32_t"],
    clip_geom: bool,
...
def tpoint_tfloat_to_geomeas(
    tpoint: Annotated[FFI.CData, "const Temporal *"],
    measure: Annotated[FFI.CData, "const Temporal *"],
    segmentize: bool,
...
def tspatial_to_stbox(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "STBox *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def bearing_tpoint_point(
    temp: Annotated[FFI.CData, "const Temporal *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"], invert: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def tgeo_centroid(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_convex_hull(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_traversed_area(
    temp: Annotated[FFI.CData, "const Temporal *"], unary_union: bool
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[list, "GSERIALIZED **"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("GSERIALIZED **")
...
def tpoint_angular_difference(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_azimuth(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_cumulative_length(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_direction(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("double *")
...
def tpoint_get_x(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_get_y(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_get_z(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_is_simple(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[bool, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_length(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_speed(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpoint_twcentroid(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_affine(
    temp: Annotated[FFI.CData, "const Temporal *"], a: Annotated[FFI.CData, "const AFFINE *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_scale(
    temp: Annotated[FFI.CData, "const Temporal *"],
    scale: Annotated[FFI.CData, "const GSERIALIZED *"],
    sorigin: Annotated[FFI.CData, "const GSERIALIZED *"],
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tspatial_srid(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "int32_t"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tspatial_set_srid(
    temp: Annotated[FFI.CData, "const Temporal *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    srid_converted = _ffi.cast("int32_t", srid)
...
def tgeo_at_geom(
    temp: Annotated[FFI.CData, "const Temporal *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def tgeo_at_stbox(
    temp: Annotated[FFI.CData, "const Temporal *"], box: Annotated[FFI.CData, "const STBox *"], border_inc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    box_converted = _ffi.cast("const STBox *", box)
...
def tgeo_at_value(
    temp: Annotated[FFI.CData, "const Temporal *"], gs: Annotated[FFI.CData, "GSERIALIZED *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    gs_converted = _ffi.cast("GSERIALIZED *", gs)
...
def tpoint_at_geom(
    temp: Annotated[FFI.CData, "const Temporal *"],
    gs: Annotated[FFI.CData, "const GSERIALIZED *"],
    zspan: Annotated[FFI.CData, "const Span *"],
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def adjacent_stbox_tspatial(
    box: Annotated[FFI.CData, "const STBox *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[bool, "bool"]:
    box_converted = _ffi.cast("const STBox *", box)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def adjacent_tspatial_stbox(
    temp: Annotated[FFI.CData, "const Temporal *"], box: Annotated[FFI.CData, "const STBox *"]
) -> Annotated[bool, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    box_converted = _ffi.cast("const STBox *", box)
...
def adwithin_tgeo_geo(
    temp: Annotated[FFI.CData, "const Temporal *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"], dist: float
) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def adwithin_tgeo_tgeo(
    temp1: Annotated[FFI.CData, "const Temporal *"], temp2: Annotated[FFI.CData, "const Temporal *"], dist: float
) -> Annotated[int, "int"]:
    temp1_converted = _ffi.cast("const Temporal *", temp1)
    temp2_converted = _ffi.cast("const Temporal *", temp2)
...
def nad_stbox_geo(
    box: Annotated[FFI.CData, "const STBox *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[float, "double"]:
    box_converted = _ffi.cast("const STBox *", box)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def tpoint_tcentroid_finalfn(state: Annotated[FFI.CData, "SkipList *"]) -> Annotated[FFI.CData, "Temporal *"]:
    state_converted = _ffi.cast("SkipList *", state)
...
def tpoint_tcentroid_transfn(
    state: Annotated[FFI.CData, "SkipList *"], temp: Annotated[FFI.CData, "Temporal *"]
) -> Annotated[FFI.CData, "SkipList *"]:
    state_converted = _ffi.cast("SkipList *", state)
    temp_converted = _ffi.cast("Temporal *", temp)
...
def tspatial_extent_transfn(
    box: Annotated[FFI.CData, "STBox *"] | None, temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "STBox *"]:
...
def stbox_get_space_tile(
    point: Annotated[FFI.CData, "const GSERIALIZED *"],
    xsize: float,
    ysize: float,
    zsize: float,
    sorigin: Annotated[FFI.CData, "const GSERIALIZED *"],
...
def stbox_space_time_tiles(
    ...
    torigin: int,
    border_inc: bool,
) -> tuple[Annotated[FFI.CData, "STBox *"], Annotated[FFI.CData, "int"]]:
    bounds_converted = _ffi.cast("const STBox *", bounds)
    duration_converted = _ffi.cast("const Interval *", duration) if duration is not None else _ffi.NULL
    sorigin_converted = _ffi.cast("const GSERIALIZED *", sorigin)
    torigin_converted = _ffi.cast("TimestampTz", torigin)
...
def tgeo_space_split(
    ...
    bitmatrix: bool,
    border_inc: bool,
) -> tuple[Annotated[FFI.CData, "Temporal **"], Annotated[list, "GSERIALIZED ***"], Annotated[FFI.CData, "int"]]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    sorigin_converted = _ffi.cast("const GSERIALIZED *", sorigin)
...
def geo_cluster_kmeans(
    ...
    ngeoms: Annotated[FFI.CData, "uint32_t"],
    k: Annotated[FFI.CData, "uint32_t"],
) -> Annotated[FFI.CData, "int *"]:
...
def tempsubtype_name(subtype: Annotated[FFI.CData, "tempSubtype"]) -> Annotated[str, "const char *"]:
...
def tempsubtype_from_string(string: str, subtype: Annotated[FFI.CData, "int16 *"]) -> Annotated[bool, "bool"]:
    string_converted = string.encode("utf-8")
...
def meosoper_name(oper: Annotated[FFI.CData, "meosOper"]) -> Annotated[str, "const char *"]:
...
def meosoper_from_string(name: str) -> Annotated[FFI.CData, "meosOper"]:
...
def meostype_name(type: Annotated[FFI.CData, "meosType"]) -> Annotated[str, "const char *"]:
...
def temptype_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "meosType"]:
    type_converted = _ffi.cast("meosType", type)
...
def settype_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "meosType"]:
    type_converted = _ffi.cast("meosType", type)
...
def spantype_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "meosType"]:
    type_converted = _ffi.cast("meosType", type)
...
def spantype_spansettype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "meosType"]:
    type_converted = _ffi.cast("meosType", type)
...
def spansettype_spantype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "meosType"]:
    type_converted = _ffi.cast("meosType", type)
...
def basetype_spantype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "meosType"]:
    type_converted = _ffi.cast("meosType", type)
...
def basetype_settype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "meosType"]:
    type_converted = _ffi.cast("meosType", type)
...
def tnumber_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def geo_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def time_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def set_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def numset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_numset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def timeset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def set_spantype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_set_spantype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def alphanumset_type(settype: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
...
def geoset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_geoset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def spatialset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_spatialset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def span_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def span_canon_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def span_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def type_span_bbox(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def span_tbox_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_span_tbox_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def numspan_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def numspan_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_numspan_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def timespan_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def timespan_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def spanset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def timespanset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_timespanset_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def temporal_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def temptype_continuous(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def basetype_byvalue(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def basetype_varlength(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def basetype_length(type: Annotated[FFI.CData, "meosType"]) -> Annotated[int, "int16"]:
    type_converted = _ffi.cast("meosType", type)
...
def talpha_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tnumber_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tnumber_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tnumber_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tnumber_spantype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def spatial_basetype(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tspatial_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tspatial_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tpoint_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tpoint_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tgeo_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tgeo_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tgeo_type_all(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tgeo_type_all(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tgeometry_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tgeometry_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def tgeodetic_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tgeodetic_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def ensure_tnumber_tpoint_type(type: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
    type_converted = _ffi.cast("meosType", type)
...
def cbuffer_as_ewkt(cb: Annotated[FFI.CData, "const Cbuffer *"], maxdd: int) -> Annotated[str, "char *"]:
...
def cbuffer_as_hexwkb(cb: Annotated[FFI.CData, "const Cbuffer *"], variant: int) -> Annotated[str, "char *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    variant_converted = _ffi.cast("uint8_t", variant)
...
def cbuffer_as_text(cb: Annotated[FFI.CData, "const Cbuffer *"], maxdd: int) -> Annotated[str, "char *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_as_wkb(cb: Annotated[FFI.CData, "const Cbuffer *"], variant: int) -> bytes:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def cbuffer_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "Cbuffer *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def cbuffer_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "CBuffer *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.cbuffer_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def cbuffer_in(string: str) -> Annotated[FFI.CData, "Cbuffer *"]:
    string_converted = string.encode("utf-8")
...
def cbuffer_out(cb: Annotated[FFI.CData, "const Cbuffer *"], maxdd: int) -> Annotated[str, "char *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_copy(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[FFI.CData, "Cbuffer *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_make(
    point: Annotated[FFI.CData, "const GSERIALIZED *"], radius: float
) -> Annotated[FFI.CData, "Cbuffer *"]:
    point_converted = _ffi.cast("const GSERIALIZED *", point)
...
def cbuffer_to_geom(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_to_stbox(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[FFI.CData, "STBox *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbufferarr_to_geom(cbarr: Annotated[list, "const Cbuffer **"], count: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
...
def geom_to_cbuffer(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "Cbuffer *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def cbuffer_hash(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[int, "uint32"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_hash_extended(cb: Annotated[FFI.CData, "const Cbuffer *"], seed: int) -> Annotated[int, "uint64"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    seed_converted = _ffi.cast("uint64", seed)
...
def cbuffer_point(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_radius(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[float, "double"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_round(cb: Annotated[FFI.CData, "const Cbuffer *"], maxdd: int) -> Annotated[FFI.CData, "Cbuffer *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_set_srid(
    cb: Annotated[FFI.CData, "Cbuffer *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[None, "void"]:
...
def cbuffer_srid(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[FFI.CData, "int32_t"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbuffer_transform(
    cb: Annotated[FFI.CData, "const Cbuffer *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "Cbuffer *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    srid_converted = _ffi.cast("int32_t", srid)
...
def cbuffer_transform_pipeline(
    cb: Annotated[FFI.CData, "const Cbuffer *"],
    pipelinestr: str,
    srid: Annotated[FFI.CData, "int32_t"],
    is_forward: bool,
) -> Annotated[FFI.CData, "Cbuffer *"]:
...
def contains_cbuffer_cbuffer(
    cb1: Annotated[FFI.CData, "const Cbuffer *"], cb2: Annotated[FFI.CData, "const Cbuffer *"]
) -> Annotated[int, "int"]:
...
def dwithin_cbuffer_cbuffer(
    cb1: Annotated[FFI.CData, "const Cbuffer *"], cb2: Annotated[FFI.CData, "const Cbuffer *"], dist: float
) -> Annotated[int, "int"]:
    cb1_converted = _ffi.cast("const Cbuffer *", cb1)
    cb2_converted = _ffi.cast("const Cbuffer *", cb2)
...
def cbuffer_tstzspan_to_stbox(
    cb: Annotated[FFI.CData, "const Cbuffer *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "STBox *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    s_converted = _ffi.cast("const Span *", s)
...
def cbuffer_timestamptz_to_stbox(
    cb: Annotated[FFI.CData, "const Cbuffer *"], t: int
) -> Annotated[FFI.CData, "STBox *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    t_converted = _ffi.cast("TimestampTz", t)
...
def distance_cbuffer_geo(
    cb: Annotated[FFI.CData, "const Cbuffer *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[float, "double"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def distance_cbuffer_stbox(
    cb: Annotated[FFI.CData, "const Cbuffer *"], box: Annotated[FFI.CData, "const STBox *"]
) -> Annotated[float, "double"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    box_converted = _ffi.cast("const STBox *", box)
...
def cbufferset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def cbufferset_out(s: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def cbufferset_make(values: Annotated[list, "const Cbuffer **"], count: int) -> Annotated[FFI.CData, "Set *"]:
...
def cbuffer_to_set(cb: Annotated[FFI.CData, "const Cbuffer *"]) -> Annotated[FFI.CData, "Set *"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def cbufferset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Cbuffer *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def cbufferset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Cbuffer *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def cbufferset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[list, "Cbuffer **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def cbufferset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Cbuffer **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def cbuffer_union_transfn(
    state: Annotated[FFI.CData, "Set *"], cb: Annotated[FFI.CData, "const Cbuffer *"]
) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def contained_cbuffer_set(
    cb: Annotated[FFI.CData, "const Cbuffer *"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[bool, "bool"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    s_converted = _ffi.cast("const Set *", s)
...
def contains_set_cbuffer(
    s: Annotated[FFI.CData, "const Set *"], cb: Annotated[FFI.CData, "Cbuffer *"]
) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    cb_converted = _ffi.cast("Cbuffer *", cb)
...
def intersection_set_cbuffer(
    s: Annotated[FFI.CData, "const Set *"], cb: Annotated[FFI.CData, "const Cbuffer *"]
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def tcbuffer_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tcbuffer_make(
    tpoint: Annotated[FFI.CData, "const Temporal *"], tfloat: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    tpoint_converted = _ffi.cast("const Temporal *", tpoint)
...
def tcbuffer_points(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Set *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tcbuffer_radius(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Set *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tcbuffer_trav_area(
    temp: Annotated[FFI.CData, "const Temporal *"], merge_union: bool
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tcbuffer_to_tfloat(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tcbuffer_to_tgeompoint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeometry_to_tcbuffer(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tcbuffer_expand(temp: Annotated[FFI.CData, "const Temporal *"], dist: float) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tcbuffer_at_cbuffer(
    temp: Annotated[FFI.CData, "const Temporal *"], cb: Annotated[FFI.CData, "const Cbuffer *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def always_eq_cbuffer_tcbuffer(
    cb: Annotated[FFI.CData, "const Cbuffer *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[int, "int"]:
    cb_converted = _ffi.cast("const Cbuffer *", cb)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def adwithin_tcbuffer_cbuffer(
    temp: Annotated[FFI.CData, "const Temporal *"], cb: Annotated[FFI.CData, "const Cbuffer *"], dist: float
) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    cb_converted = _ffi.cast("const Cbuffer *", cb)
...
def npoint_as_ewkt(np: Annotated[FFI.CData, "const Npoint *"], maxdd: int) -> Annotated[str, "char *"]:
...
def npoint_as_hexwkb(np: Annotated[FFI.CData, "const Npoint *"], variant: int) -> Annotated[str, "char *"]:
    np_converted = _ffi.cast("const Npoint *", np)
    variant_converted = _ffi.cast("uint8_t", variant)
...
def npoint_as_text(np: Annotated[FFI.CData, "const Npoint *"], maxdd: int) -> Annotated[str, "char *"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def npoint_as_wkb(np: Annotated[FFI.CData, "const Npoint *"], variant: int) -> bytes:
    np_converted = _ffi.cast("const Npoint *", np)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def npoint_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "Npoint *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def npoint_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "NPoint *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.npoint_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def npoint_in(string: str) -> Annotated[FFI.CData, "Npoint *"]:
    string_converted = string.encode("utf-8")
...
def npoint_out(np: Annotated[FFI.CData, "const Npoint *"], maxdd: int) -> Annotated[str, "char *"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def nsegment_in(string: str) -> Annotated[FFI.CData, "Nsegment *"]:
    string_converted = string.encode("utf-8")
...
def nsegment_out(ns: Annotated[FFI.CData, "const Nsegment *"], maxdd: int) -> Annotated[str, "char *"]:
...
def npoint_make(rid: int, pos: float) -> Annotated[FFI.CData, "Npoint *"]:
...
def nsegment_make(rid: int, pos1: float, pos2: float) -> Annotated[FFI.CData, "Nsegment *"]:
    rid_converted = _ffi.cast("int64", rid)
...
def geompoint_to_npoint(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "Npoint *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geom_to_nsegment(gs: Annotated[FFI.CData, "const GSERIALIZED *"]) -> Annotated[FFI.CData, "Nsegment *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def npoint_to_geompoint(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def npoint_to_nsegment(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[FFI.CData, "Nsegment *"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def npoint_to_stbox(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[FFI.CData, "STBox *"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def nsegment_to_geom(ns: Annotated[FFI.CData, "const Nsegment *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    ns_converted = _ffi.cast("const Nsegment *", ns)
...
def nsegment_to_stbox(np: Annotated[FFI.CData, "const Nsegment *"]) -> Annotated[FFI.CData, "STBox *"]:
...
def npoint_hash(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[int, "uint32"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def npoint_hash_extended(np: Annotated[FFI.CData, "const Npoint *"], seed: int) -> Annotated[int, "uint64"]:
    np_converted = _ffi.cast("const Npoint *", np)
    seed_converted = _ffi.cast("uint64", seed)
...
def npoint_position(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[float, "double"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def npoint_route(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[int, "int64"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def nsegment_end_position(ns: Annotated[FFI.CData, "const Nsegment *"]) -> Annotated[float, "double"]:
    ns_converted = _ffi.cast("const Nsegment *", ns)
...
def nsegment_route(ns: Annotated[FFI.CData, "const Nsegment *"]) -> Annotated[int, "int64"]:
    ns_converted = _ffi.cast("const Nsegment *", ns)
...
def nsegment_start_position(ns: Annotated[FFI.CData, "const Nsegment *"]) -> Annotated[float, "double"]:
    ns_converted = _ffi.cast("const Nsegment *", ns)
...
def route_geom(rid: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    rid_converted = _ffi.cast("int64", rid)
...
def npoint_round(np: Annotated[FFI.CData, "const Npoint *"], maxdd: int) -> Annotated[FFI.CData, "Npoint *"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def nsegment_round(ns: Annotated[FFI.CData, "const Nsegment *"], maxdd: int) -> Annotated[FFI.CData, "Nsegment *"]:
    ns_converted = _ffi.cast("const Nsegment *", ns)
...
def get_srid_ways() -> Annotated[FFI.CData, "int32_t"]:
    result = _lib.get_srid_ways()
    _check_error()
    return result if result != _ffi.NULL else None


def npoint_srid(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[FFI.CData, "int32_t"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def nsegment_srid(ns: Annotated[FFI.CData, "const Nsegment *"]) -> Annotated[FFI.CData, "int32_t"]:
    ns_converted = _ffi.cast("const Nsegment *", ns)
...
def npoint_timestamptz_to_stbox(np: Annotated[FFI.CData, "const Npoint *"], t: int) -> Annotated[FFI.CData, "STBox *"]:
    np_converted = _ffi.cast("const Npoint *", np)
    t_converted = _ffi.cast("TimestampTz", t)
...
def npoint_tstzspan_to_stbox(
    np: Annotated[FFI.CData, "const Npoint *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "STBox *"]:
    np_converted = _ffi.cast("const Npoint *", np)
    s_converted = _ffi.cast("const Span *", s)
...
def npoint_cmp(
    np1: Annotated[FFI.CData, "const Npoint *"], np2: Annotated[FFI.CData, "const Npoint *"]
) -> Annotated[int, "int"]:
...
def nsegment_cmp(
    ns1: Annotated[FFI.CData, "const Nsegment *"], ns2: Annotated[FFI.CData, "const Nsegment *"]
) -> Annotated[int, "int"]:
...
def npointset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def npointset_out(s: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def npointset_make(values: Annotated[list, "const Npoint **"], count: int) -> Annotated[FFI.CData, "Set *"]:
...
def npoint_to_set(np: Annotated[FFI.CData, "const Npoint *"]) -> Annotated[FFI.CData, "Set *"]:
    np_converted = _ffi.cast("const Npoint *", np)
...
def npointset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Npoint *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def npointset_routes(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def npointset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Npoint *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def npointset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[list, "Npoint **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def npointset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Npoint **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contained_npoint_set(
    np: Annotated[FFI.CData, "const Npoint *"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[bool, "bool"]:
    np_converted = _ffi.cast("const Npoint *", np)
    s_converted = _ffi.cast("const Set *", s)
...
def contains_set_npoint(
    s: Annotated[FFI.CData, "const Set *"], np: Annotated[FFI.CData, "Npoint *"]
) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
...
def intersection_set_npoint(
    s: Annotated[FFI.CData, "const Set *"], np: Annotated[FFI.CData, "const Npoint *"]
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    np_converted = _ffi.cast("const Npoint *", np)
...
def npoint_union_transfn(
    state: Annotated[FFI.CData, "Set *"], np: Annotated[FFI.CData, "const Npoint *"]
) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
    np_converted = _ffi.cast("const Npoint *", np)
...
def tnpoint_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tnpoint_out(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpointinst_make(np: Annotated[FFI.CData, "const Npoint *"], t: int) -> Annotated[FFI.CData, "TInstant *"]:
    np_converted = _ffi.cast("const Npoint *", np)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tgeompoint_to_tnpoint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_to_tgeompoint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_cumulative_length(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_length(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[float, "double"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_route(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[int, "int64"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_routes(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Set *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_speed(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_trajectory(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_twcentroid(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnpoint_at_npoint(
    temp: Annotated[FFI.CData, "const Temporal *"], np: Annotated[FFI.CData, "const Npoint *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    np_converted = _ffi.cast("const Npoint *", np)
...
def always_eq_npoint_tnpoint(
    np: Annotated[FFI.CData, "const Npoint *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[int, "int"]:
    np_converted = _ffi.cast("const Npoint *", np)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def pose_as_ewkt(pose: Annotated[FFI.CData, "const Pose *"], maxdd: int) -> Annotated[str, "char *"]:
...
def pose_as_hexwkb(pose: Annotated[FFI.CData, "const Pose *"], variant: int) -> Annotated[str, "char *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    variant_converted = _ffi.cast("uint8_t", variant)
...
def pose_as_text(pose: Annotated[FFI.CData, "const Pose *"], maxdd: int) -> Annotated[str, "char *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_as_wkb(pose: Annotated[FFI.CData, "const Pose *"], variant: int) -> bytes:
    pose_converted = _ffi.cast("const Pose *", pose)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def pose_from_wkb(wkb: bytes) -> Annotated[FFI.CData, "Pose *"]:
    wkb_converted = _ffi.new("uint8_t []", wkb)
    result = _lib.pose_from_wkb(wkb_converted, len(wkb))
    return result if result != _ffi.NULL else None


def pose_from_hexwkb(hexwkb: str) -> Annotated[FFI.CData, "Pose *"]:
    hexwkb_converted = hexwkb.encode("utf-8")
...
def pose_in(string: str) -> Annotated[FFI.CData, "Pose *"]:
    string_converted = string.encode("utf-8")
...
def pose_out(pose: Annotated[FFI.CData, "const Pose *"], maxdd: int) -> Annotated[str, "char *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_copy(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[FFI.CData, "Pose *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_make_2d(
    x: float, y: float, theta: float, srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "Pose *"]:
    srid_converted = _ffi.cast("int32_t", srid)
...
def pose_make_3d(
    x: float, y: float, z: float, W: float, X: float, Y: float, Z: float, srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "Pose *"]:
    srid_converted = _ffi.cast("int32_t", srid)
...
def pose_make_point2d(gs: Annotated[FFI.CData, "const GSERIALIZED *"], theta: float) -> Annotated[FFI.CData, "Pose *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def pose_make_point3d(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], W: float, X: float, Y: float, Z: float
) -> Annotated[FFI.CData, "Pose *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def pose_to_point(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_to_stbox(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[FFI.CData, "STBox *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_hash(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[int, "uint32"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_hash_extended(pose: Annotated[FFI.CData, "const Pose *"], seed: int) -> Annotated[int, "uint64"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    seed_converted = _ffi.cast("uint64", seed)
...
def pose_orientation(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[FFI.CData, "double *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_rotation(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[float, "double"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_round(pose: Annotated[FFI.CData, "const Pose *"], maxdd: int) -> Annotated[FFI.CData, "Pose *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def posearr_round(posearr: Annotated[list, "const Pose **"], count: int, maxdd: int) -> Annotated[FFI.CData, "Pose **"]:
...
def pose_set_srid(
    pose: Annotated[FFI.CData, "Pose *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[None, "void"]:
...
def pose_srid(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[FFI.CData, "int32_t"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_transform(
    pose: Annotated[FFI.CData, "const Pose *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "Pose *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    srid_converted = _ffi.cast("int32_t", srid)
...
def pose_transform_pipeline(
    pose: Annotated[FFI.CData, "const Pose *"],
    pipelinestr: str,
    srid: Annotated[FFI.CData, "int32_t"],
    is_forward: bool,
) -> Annotated[FFI.CData, "Pose *"]:
...
def pose_tstzspan_to_stbox(
    pose: Annotated[FFI.CData, "const Pose *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "STBox *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    s_converted = _ffi.cast("const Span *", s)
...
def pose_timestamptz_to_stbox(pose: Annotated[FFI.CData, "const Pose *"], t: int) -> Annotated[FFI.CData, "STBox *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    t_converted = _ffi.cast("TimestampTz", t)
...
def distance_pose_geo(
    pose: Annotated[FFI.CData, "const Pose *"], gs: Annotated[FFI.CData, "const GSERIALIZED *"]
) -> Annotated[float, "double"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def distance_pose_pose(
    pose1: Annotated[FFI.CData, "const Pose *"], pose2: Annotated[FFI.CData, "const Pose *"]
) -> Annotated[float, "double"]:
...
def distance_pose_stbox(
    pose: Annotated[FFI.CData, "const Pose *"], box: Annotated[FFI.CData, "const STBox *"]
) -> Annotated[float, "double"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    box_converted = _ffi.cast("const STBox *", box)
...
def poseset_in(string: str) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
...
def poseset_out(s: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def poseset_make(values: Annotated[list, "const Pose **"], count: int) -> Annotated[FFI.CData, "Set *"]:
...
def pose_to_set(pose: Annotated[FFI.CData, "const Pose *"]) -> Annotated[FFI.CData, "Set *"]:
    pose_converted = _ffi.cast("const Pose *", pose)
...
def poseset_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Pose *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def poseset_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Pose *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def poseset_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[list, "Pose **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def poseset_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Pose **"]:
    s_converted = _ffi.cast("const Set *", s)
...
def contained_pose_set(
    pose: Annotated[FFI.CData, "const Pose *"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[bool, "bool"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    s_converted = _ffi.cast("const Set *", s)
...
def contains_set_pose(
    s: Annotated[FFI.CData, "const Set *"], pose: Annotated[FFI.CData, "Pose *"]
) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    pose_converted = _ffi.cast("Pose *", pose)
...
def intersection_set_pose(
    s: Annotated[FFI.CData, "const Set *"], pose: Annotated[FFI.CData, "const Pose *"]
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    pose_converted = _ffi.cast("const Pose *", pose)
...
def pose_union_transfn(
    state: Annotated[FFI.CData, "Set *"], pose: Annotated[FFI.CData, "const Pose *"]
) -> Annotated[FFI.CData, "Set *"]:
    state_converted = _ffi.cast("Set *", state)
    pose_converted = _ffi.cast("const Pose *", pose)
...
def tpose_in(string: str) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
...
def tpose_make(
    tpoint: Annotated[FFI.CData, "const Temporal *"], tradius: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    tpoint_converted = _ffi.cast("const Temporal *", tpoint)
...
def tpose_to_tpoint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpose_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Pose *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpose_points(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Set *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpose_rotation(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpose_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Pose *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpose_trajectory(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tpose_value_at_timestamptz(
    temp: Annotated[FFI.CData, "const Temporal *"], t: int, strict: bool, value: Annotated[list, "Pose **"]
) -> Annotated[bool, "bool"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tpose_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[list, "Pose **"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("Pose **")
...
def tpose_at_pose(
    temp: Annotated[FFI.CData, "const Temporal *"], pose: Annotated[FFI.CData, "const Pose *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    pose_converted = _ffi.cast("const Pose *", pose)
...
def always_eq_pose_tpose(
    pose: Annotated[FFI.CData, "const Pose *"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[int, "int"]:
    pose_converted = _ffi.cast("const Pose *", pose)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_out(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeoinst_make(
    geom: Annotated[FFI.CData, "const GSERIALIZED *"], pose: Annotated[FFI.CData, "const Pose *"], t: int
) -> Annotated[FFI.CData, "TInstant *"]:
    geom_converted = _ffi.cast("const GSERIALIZED *", geom)
    pose_converted = _ffi.cast("const Pose *", pose)
    t_converted = _ffi.cast("TimestampTz", t)
...
def trgeo_to_tpose(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_to_tpoint(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_end_instant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_end_sequence(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TSequence *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_geom(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_instant_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_sequence_n(temp: Annotated[FFI.CData, "const Temporal *"], i: int) -> Annotated[FFI.CData, "TSequence *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_start_instant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_start_sequence(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TSequence *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[list, "GSERIALIZED **"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("GSERIALIZED **")
...
def trgeo_append_tinstant(
    ...
    interp: InterpolationType,
    maxdist: float,
    maxt: Annotated[FFI.CData, "const Interval *"],
    expand: bool,
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("Temporal *", temp)
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def trgeo_round(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_to_tinstant(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def trgeo_restrict_value(
    temp: Annotated[FFI.CData, "const Temporal *"], value: Annotated[FFI.CData, "Datum"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    value_converted = _ffi.cast("Datum", value)
...
def trgeo_restrict_values(
    temp: Annotated[FFI.CData, "const Temporal *"], s: Annotated[FFI.CData, "const Set *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    s_converted = _ffi.cast("const Set *", s)
...
def trgeo_restrict_timestamptz(
    temp: Annotated[FFI.CData, "const Temporal *"], t: int, atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    t_converted = _ffi.cast("TimestampTz", t)
...
def trgeo_restrict_tstzspan(
    temp: Annotated[FFI.CData, "const Temporal *"], s: Annotated[FFI.CData, "const Span *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    s_converted = _ffi.cast("const Span *", s)
...
def trgeo_restrict_tstzspanset(
    temp: Annotated[FFI.CData, "const Temporal *"], ss: Annotated[FFI.CData, "const SpanSet *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def gsl_get_generation_rng() -> Annotated[FFI.CData, "gsl_rng *"]:
    result = _lib.gsl_get_generation_rng()
    _check_error()
    return result if result != _ffi.NULL else None


def gsl_get_aggregation_rng() -> Annotated[FFI.CData, "gsl_rng *"]:
    result = _lib.gsl_get_aggregation_rng()
    _check_error()
    return result if result != _ffi.NULL else None


def datum_ceil(d: Annotated[FFI.CData, "Datum"]) -> Annotated[FFI.CData, "Datum"]:
...
def datum_degrees(
    d: Annotated[FFI.CData, "Datum"], normalize: Annotated[FFI.CData, "Datum"]
) -> Annotated[FFI.CData, "Datum"]:
    d_converted = _ffi.cast("Datum", d)
...
def datum_float_round(
    value: Annotated[FFI.CData, "Datum"], size: Annotated[FFI.CData, "Datum"]
) -> Annotated[FFI.CData, "Datum"]:
    value_converted = _ffi.cast("Datum", value)
...
def datum_floor(d: Annotated[FFI.CData, "Datum"]) -> Annotated[FFI.CData, "Datum"]:
    d_converted = _ffi.cast("Datum", d)
...
def datum_hash(
    d: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"]
...
def datum_hash_extended(
    d: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"], seed: int
...
def datum_radians(d: Annotated[FFI.CData, "Datum"]) -> Annotated[FFI.CData, "Datum"]:
    d_converted = _ffi.cast("Datum", d)
...
def floatspan_round_set(s: Annotated[FFI.CData, "const Span *"], maxdd: int) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def set_in(string: str, basetype: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "Set *"]:
    string_converted = string.encode("utf-8")
    basetype_converted = _ffi.cast("meosType", basetype)
...
def set_out(s: Annotated[FFI.CData, "const Set *"], maxdd: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def span_in(string: str, spantype: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "Span *"]:
    string_converted = string.encode("utf-8")
...
def span_out(s: Annotated[FFI.CData, "const Span *"], maxdd: int) -> Annotated[str, "char *"]:
    s_converted = _ffi.cast("const Span *", s)
...
def spanset_in(string: str, spantype: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "SpanSet *"]:
    string_converted = string.encode("utf-8")
    spantype_converted = _ffi.cast("meosType", spantype)
...
def spanset_out(ss: Annotated[FFI.CData, "const SpanSet *"], maxdd: int) -> Annotated[str, "char *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def set_make(
    values: Annotated[FFI.CData, "const Datum *"], count: int, basetype: Annotated[FFI.CData, "meosType"], order: bool
) -> Annotated[FFI.CData, "Set *"]:
...
def set_make_exp(
    values: Annotated[FFI.CData, "const Datum *"],
    count: int,
    maxcount: int,
    basetype: Annotated[FFI.CData, "meosType"],
    order: bool,
) -> Annotated[FFI.CData, "Set *"]:
    values_converted = _ffi.cast("const Datum *", values)
    basetype_converted = _ffi.cast("meosType", basetype)
...
def set_make_free(
    values: Annotated[FFI.CData, "Datum *"], count: int, basetype: Annotated[FFI.CData, "meosType"], order: bool
) -> Annotated[FFI.CData, "Set *"]:
...
def span_make(
    lower: Annotated[FFI.CData, "Datum"],
    upper: Annotated[FFI.CData, "Datum"],
    lower_inc: bool,
    upper_inc: bool,
    basetype: Annotated[FFI.CData, "meosType"],
) -> Annotated[FFI.CData, "Span *"]:
...
def span_set(
    ...
    upper_inc: bool,
    basetype: Annotated[FFI.CData, "meosType"],
    spantype: Annotated[FFI.CData, "meosType"],
    s: Annotated[FFI.CData, "Span *"],
) -> Annotated[None, "void"]:
    lower_converted = _ffi.cast("Datum", lower)
    upper_converted = _ffi.cast("Datum", upper)
    basetype_converted = _ffi.cast("meosType", basetype)
...
def spanset_make_exp(
    spans: Annotated[FFI.CData, "Span *"], count: int, maxcount: int, normalize: bool, order: bool
) -> Annotated[FFI.CData, "SpanSet *"]:
...
def spanset_make_free(
    spans: Annotated[FFI.CData, "Span *"], count: int, normalize: bool, order: bool
) -> Annotated[FFI.CData, "SpanSet *"]:
    spans_converted = _ffi.cast("Span *", spans)
...
def set_span(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_spanset(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def value_set_span(
    value: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"], s: Annotated[FFI.CData, "Span *"]
) -> Annotated[None, "void"]:
    value_converted = _ffi.cast("Datum", value)
    basetype_converted = _ffi.cast("meosType", basetype)
    s_converted = _ffi.cast("Span *", s)
...
def numspan_width(s: Annotated[FFI.CData, "const Span *"]) -> Annotated[FFI.CData, "Datum"]:
    s_converted = _ffi.cast("const Span *", s)
...
def numspanset_width(ss: Annotated[FFI.CData, "const SpanSet *"], boundspan: bool) -> Annotated[FFI.CData, "Datum"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def set_end_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Datum"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_mem_size(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[int, "int"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_set_subspan(s: Annotated[FFI.CData, "const Set *"], minidx: int, maxidx: int) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Set *", s)
    out_result = _ffi.new("Span *")
...
def set_set_span(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Set *", s)
    out_result = _ffi.new("Span *")
...
def set_start_value(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Datum"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_value_n(s: Annotated[FFI.CData, "const Set *"], n: int) -> Annotated[FFI.CData, "Datum *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_vals(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Datum *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_values(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Datum *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def spanset_lower(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Datum"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_mem_size(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_sps(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "const Span **"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def spanset_upper(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "Datum"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def datespan_set_tstzspan(
    s1: Annotated[FFI.CData, "const Span *"], s2: Annotated[FFI.CData, "Span *"]
) -> Annotated[None, "void"]:
    s1_converted = _ffi.cast("const Span *", s1)
...
def numset_shift_scale(
    s: Annotated[FFI.CData, "const Set *"],
    shift: Annotated[FFI.CData, "Datum"],
    width: Annotated[FFI.CData, "Datum"],
    hasshift: bool,
    haswidth: bool,
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def set_compact(s: Annotated[FFI.CData, "const Set *"]) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
...
def spanset_compact(ss: Annotated[FFI.CData, "const SpanSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tbox_expand_value(
    box: Annotated[FFI.CData, "const TBox *"],
    value: Annotated[FFI.CData, "Datum"],
    basetyp: Annotated[FFI.CData, "meosType"],
) -> Annotated[FFI.CData, "TBox *"]:
    box_converted = _ffi.cast("const TBox *", box)
    value_converted = _ffi.cast("Datum", value)
...
def textcat_textset_text_int(
    s: Annotated[FFI.CData, "const Set *"], txt: str, invert: bool
) -> Annotated[FFI.CData, "Set *"]:
    s_converted = _ffi.cast("const Set *", s)
    txt_converted = cstring2text(txt)
...
def adjacent_spanset_value(
    ss: Annotated[FFI.CData, "const SpanSet *"], value: Annotated[FFI.CData, "Datum"]
) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const SpanSet *", ss)
    value_converted = _ffi.cast("Datum", value)
...
def adjacent_value_spanset(
    value: Annotated[FFI.CData, "Datum"], ss: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[bool, "bool"]:
    value_converted = _ffi.cast("Datum", value)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def contained_value_set(
    value: Annotated[FFI.CData, "Datum"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[bool, "bool"]:
    value_converted = _ffi.cast("Datum", value)
    s_converted = _ffi.cast("const Set *", s)
...
def contained_value_span(
    value: Annotated[FFI.CData, "Datum"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[bool, "bool"]:
    value_converted = _ffi.cast("Datum", value)
    s_converted = _ffi.cast("const Span *", s)
...
def contains_set_value(
    s: Annotated[FFI.CData, "const Set *"], value: Annotated[FFI.CData, "Datum"]
) -> Annotated[bool, "bool"]:
    s_converted = _ffi.cast("const Set *", s)
    value_converted = _ffi.cast("Datum", value)
...
def bbox_type(bboxtype: Annotated[FFI.CData, "meosType"]) -> Annotated[bool, "bool"]:
...
def bbox_get_size(bboxtype: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "size_t"]:
    bboxtype_converted = _ffi.cast("meosType", bboxtype)
...
def bbox_max_dims(bboxtype: Annotated[FFI.CData, "meosType"]) -> Annotated[int, "int"]:
    bboxtype_converted = _ffi.cast("meosType", bboxtype)
...
def temporal_bbox_eq(
    box1: Annotated[FFI.CData, "const void *"],
    box2: Annotated[FFI.CData, "const void *"],
    temptype: Annotated[FFI.CData, "meosType"],
) -> Annotated[bool, "bool"]:
...
def distance_value_value(
    l: Annotated[FFI.CData, "Datum"], r: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"]
) -> Annotated[FFI.CData, "Datum"]:
...
def spanbase_extent_transfn(
    state: Annotated[FFI.CData, "Span *"],
    value: Annotated[FFI.CData, "Datum"],
    basetype: Annotated[FFI.CData, "meosType"],
) -> Annotated[FFI.CData, "Span *"]:
    state_converted = _ffi.cast("Span *", state)
...
def number_timestamptz_to_tbox(
    d: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"], t: int
) -> Annotated[FFI.CData, "TBox *"]:
    d_converted = _ffi.cast("Datum", d)
    basetype_converted = _ffi.cast("meosType", basetype)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tbox_set(
    s: Annotated[FFI.CData, "const Span *"],
    p: Annotated[FFI.CData, "const Span *"],
    box: Annotated[FFI.CData, "TBox *"],
) -> Annotated[None, "void"]:
    s_converted = _ffi.cast("const Span *", s)
...
def float_set_tbox(d: float, box: Annotated[FFI.CData, "TBox *"]) -> Annotated[None, "void"]:
    box_converted = _ffi.cast("TBox *", box)
    _lib.float_set_tbox(d, box_converted)
    _check_error()


def int_set_tbox(i: int, box: Annotated[FFI.CData, "TBox *"]) -> Annotated[None, "void"]:
    box_converted = _ffi.cast("TBox *", box)
...
def number_set_tbox(
    d: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    d_converted = _ffi.cast("Datum", d)
    basetype_converted = _ffi.cast("meosType", basetype)
    box_converted = _ffi.cast("TBox *", box)
...
def number_tbox(
    value: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"]
) -> Annotated[FFI.CData, "TBox *"]:
    value_converted = _ffi.cast("Datum", value)
    basetype_converted = _ffi.cast("meosType", basetype)
...
def numset_set_tbox(
    s: Annotated[FFI.CData, "const Set *"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    s_converted = _ffi.cast("const Set *", s)
    box_converted = _ffi.cast("TBox *", box)
...
def numspan_set_tbox(
    span: Annotated[FFI.CData, "const Span *"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    span_converted = _ffi.cast("const Span *", span)
    box_converted = _ffi.cast("TBox *", box)
...
def timestamptz_set_tbox(t: int, box: Annotated[FFI.CData, "TBox *"]) -> Annotated[None, "void"]:
    t_converted = _ffi.cast("TimestampTz", t)
    box_converted = _ffi.cast("TBox *", box)
...
def tstzspan_set_tbox(
    s: Annotated[FFI.CData, "const Span *"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    s_converted = _ffi.cast("const Span *", s)
    box_converted = _ffi.cast("TBox *", box)
...
def tbox_expand(
    box1: Annotated[FFI.CData, "const TBox *"], box2: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    box1_converted = _ffi.cast("const TBox *", box1)
...
def tboolinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def tboolseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def tboolseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def temporal_in(string: str, temptype: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "Temporal *"]:
    string_converted = string.encode("utf-8")
    temptype_converted = _ffi.cast("meosType", temptype)
...
def temporal_out(temp: Annotated[FFI.CData, "const Temporal *"], maxdd: int) -> Annotated[str, "char *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tfloatinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def tfloatseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def tfloatseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def tinstant_in(string: str, temptype: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
    temptype_converted = _ffi.cast("meosType", temptype)
...
def tinstant_out(inst: Annotated[FFI.CData, "const TInstant *"], maxdd: int) -> Annotated[str, "char *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tintinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def tintseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def tintseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def tsequence_in(
    string: str, temptype: Annotated[FFI.CData, "meosType"], interp: InterpolationType
) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
    temptype_converted = _ffi.cast("meosType", temptype)
...
def tsequence_out(seq: Annotated[FFI.CData, "const TSequence *"], maxdd: int) -> Annotated[str, "char *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequenceset_out(ss: Annotated[FFI.CData, "const TSequenceSet *"], maxdd: int) -> Annotated[str, "char *"]:
...
def ttextinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def ttextseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def ttextseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def temporal_from_mfjson(mfjson: str, temptype: Annotated[FFI.CData, "meosType"]) -> Annotated[FFI.CData, "Temporal *"]:
    mfjson_converted = mfjson.encode("utf-8")
    temptype_converted = _ffi.cast("meosType", temptype)
...
def tinstant_copy(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tinstant_make(
    value: Annotated[FFI.CData, "Datum"], temptype: Annotated[FFI.CData, "meosType"], t: int
) -> Annotated[FFI.CData, "TInstant *"]:
    value_converted = _ffi.cast("Datum", value)
    temptype_converted = _ffi.cast("meosType", temptype)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tsequence_copy(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_from_base_temp(
    value: Annotated[FFI.CData, "Datum"],
    temptype: Annotated[FFI.CData, "meosType"],
    seq: Annotated[FFI.CData, "const TSequence *"],
) -> Annotated[FFI.CData, "TSequence *"]:
    value_converted = _ffi.cast("Datum", value)
    temptype_converted = _ffi.cast("meosType", temptype)
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequenceset_copy(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_from_base_temp(
    value: Annotated[FFI.CData, "Datum"],
    temptype: Annotated[FFI.CData, "meosType"],
    ss: Annotated[FFI.CData, "const TSequenceSet *"],
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    value_converted = _ffi.cast("Datum", value)
    temptype_converted = _ffi.cast("meosType", temptype)
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def temporal_set_tstzspan(
    temp: Annotated[FFI.CData, "const Temporal *"], s: Annotated[FFI.CData, "Span *"]
) -> Annotated[None, "void"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    s_converted = _ffi.cast("Span *", s)
...
def tinstant_set_tstzspan(
    inst: Annotated[FFI.CData, "const TInstant *"], s: Annotated[FFI.CData, "Span *"]
) -> Annotated[None, "void"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    s_converted = _ffi.cast("Span *", s)
...
def tnumber_set_tbox(
    temp: Annotated[FFI.CData, "const Temporal *"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    box_converted = _ffi.cast("TBox *", box)
...
def tnumberinst_set_tbox(
    inst: Annotated[FFI.CData, "const TInstant *"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    box_converted = _ffi.cast("TBox *", box)
...
def tnumberseq_set_tbox(
    seq: Annotated[FFI.CData, "const TSequence *"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    box_converted = _ffi.cast("TBox *", box)
...
def tnumberseqset_set_tbox(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], box: Annotated[FFI.CData, "TBox *"]
) -> Annotated[None, "void"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    box_converted = _ffi.cast("TBox *", box)
...
def tsequence_set_tstzspan(
    seq: Annotated[FFI.CData, "const TSequence *"], s: Annotated[FFI.CData, "Span *"]
) -> Annotated[None, "void"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    s_converted = _ffi.cast("Span *", s)
...
def tsequenceset_set_tstzspan(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], s: Annotated[FFI.CData, "Span *"]
) -> Annotated[None, "void"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    s_converted = _ffi.cast("Span *", s)
...
def temporal_end_inst(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "const TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_end_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Datum"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_inst_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[FFI.CData, "const TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_instants_p(
    temp: Annotated[FFI.CData, "const Temporal *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "const TInstant **"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def temporal_max_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Datum"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_mem_size(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "size_t"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_min_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Datum"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_sequences_p(
    temp: Annotated[FFI.CData, "const Temporal *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "const TSequence **"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    count_converted = _ffi.cast("int *", count)
...
def temporal_set_bbox(
    temp: Annotated[FFI.CData, "const Temporal *"], box: Annotated[FFI.CData, "void *"]
) -> Annotated[None, "void"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    box_converted = _ffi.cast("void *", box)
...
def temporal_start_inst(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "const TInstant *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_start_value(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Datum"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_value_n(temp: Annotated[FFI.CData, "const Temporal *"], n: int) -> Annotated[FFI.CData, "Datum *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    out_result = _ffi.new("Datum *")
...
def tinstant_hash(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[int, "uint32"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tinstant_insts(
    inst: Annotated[FFI.CData, "const TInstant *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "const TInstant **"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    count_converted = _ffi.cast("int *", count)
...
def tinstant_set_bbox(
    inst: Annotated[FFI.CData, "const TInstant *"], box: Annotated[FFI.CData, "void *"]
) -> Annotated[None, "void"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    box_converted = _ffi.cast("void *", box)
...
def tinstant_time(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tinstant_value_p(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[FFI.CData, "Datum"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tinstant_value(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[FFI.CData, "Datum"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tinstant_value_at_timestamptz(
    inst: Annotated[FFI.CData, "const TInstant *"], t: int
) -> Annotated[FFI.CData, "Datum *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    t_converted = _ffi.cast("TimestampTz", t)
    out_result = _ffi.new("Datum *")
...
def tnumber_set_span(
    temp: Annotated[FFI.CData, "const Temporal *"], span: Annotated[FFI.CData, "Span *"]
) -> Annotated[None, "void"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tnumberinst_valuespans(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tnumberseq_avg_val(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[float, "double"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tnumberseq_valuespans(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tnumberseqset_avg_val(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tnumberseqset_valuespans(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequence_duration(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "Interval *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_end_timestamptz(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[int, "TimestampTz"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_hash(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[int, "uint32"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_insts_p(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "const TInstant **"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_max_inst(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "const TInstant *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_max_val(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "Datum"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_min_inst(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "const TInstant *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_min_val(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "Datum"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_segments(
    seq: Annotated[FFI.CData, "const TSequence *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "TSequence **"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    count_converted = _ffi.cast("int *", count)
...
def tsequence_start_timestamptz(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[int, "TimestampTz"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_time(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_value_at_timestamptz(
    seq: Annotated[FFI.CData, "const TSequence *"], t: int, strict: bool
) -> Annotated[FFI.CData, "Datum *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    t_converted = _ffi.cast("TimestampTz", t)
    out_result = _ffi.new("Datum *")
...
def tsequenceset_duration(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], boundspan: bool
) -> Annotated[FFI.CData, "Interval *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_end_timestamptz(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[int, "TimestampTz"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_hash(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[int, "uint32"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_inst_n(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], n: int
) -> Annotated[FFI.CData, "const TInstant *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_insts_p(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "const TInstant **"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_max_inst(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "const TInstant *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_max_val(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "Datum"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_min_inst(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "const TInstant *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_min_val(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "Datum"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_num_instants(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_num_timestamps(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[int, "int"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_segments(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "TSequence **"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    count_converted = _ffi.cast("int *", count)
...
def tsequenceset_start_timestamptz(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[int, "TimestampTz"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_time(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "SpanSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_timestamptz_n(ss: Annotated[FFI.CData, "const TSequenceSet *"], n: int) -> int:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    out_result = _ffi.new("TimestampTz *")
...
def tsequenceset_value_at_timestamptz(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], t: int, strict: bool
) -> Annotated[FFI.CData, "Datum *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
    out_result = _ffi.new("Datum *")
...
def tsequenceset_value_n(ss: Annotated[FFI.CData, "const TSequenceSet *"], n: int) -> Annotated[FFI.CData, "Datum *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    out_result = _ffi.new("Datum *")
...
def temporal_restart(temp: Annotated[FFI.CData, "Temporal *"], count: int) -> Annotated[None, "void"]:
    temp_converted = _ffi.cast("Temporal *", temp)
...
def tinstant_shift_time(
    inst: Annotated[FFI.CData, "const TInstant *"], interv: Annotated[FFI.CData, "const Interval *"]
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    interv_converted = _ffi.cast("const Interval *", interv)
...
def tinstant_to_tsequence(
    inst: Annotated[FFI.CData, "const TInstant *"], interp: InterpolationType
) -> Annotated[FFI.CData, "TSequence *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tinstant_to_tsequence_free(
    inst: Annotated[FFI.CData, "TInstant *"], interp: InterpolationType
) -> Annotated[FFI.CData, "TSequence *"]:
...
def tnumberinst_shift_value(
    inst: Annotated[FFI.CData, "const TInstant *"], shift: Annotated[FFI.CData, "Datum"]
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    shift_converted = _ffi.cast("Datum", shift)
...
def tnumberseqset_shift_scale_value(
    ss: Annotated[FFI.CData, "const TSequenceSet *"],
    start: Annotated[FFI.CData, "Datum"],
    width: Annotated[FFI.CData, "Datum"],
    hasshift: bool,
    haswidth: bool,
) -> Annotated[FFI.CData, "TSequenceSet *"]:
...
def tsequence_restart(seq: Annotated[FFI.CData, "TSequence *"], count: int) -> Annotated[None, "void"]:
...
def tsequence_set_interp(
    seq: Annotated[FFI.CData, "const TSequence *"], interp: InterpolationType
) -> Annotated[FFI.CData, "Temporal *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_shift_scale_time(
    seq: Annotated[FFI.CData, "const TSequence *"],
    shift: Annotated[FFI.CData, "const Interval *"],
    duration: Annotated[FFI.CData, "const Interval *"],
) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    shift_converted = _ffi.cast("const Interval *", shift)
...
def tsequence_subseq(
    seq: Annotated[FFI.CData, "const TSequence *"], from_: int, to: int, lower_inc: bool, upper_inc: bool
) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_to_tinstant(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "TInstant *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_to_tsequenceset(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequence_to_tsequenceset_free(seq: Annotated[FFI.CData, "TSequence *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    seq_converted = _ffi.cast("TSequence *", seq)
...
def tsequenceset_restart(ss: Annotated[FFI.CData, "TSequenceSet *"], count: int) -> Annotated[None, "void"]:
...
def tsequenceset_set_interp(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], interp: InterpolationType
) -> Annotated[FFI.CData, "Temporal *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_shift_scale_time(
    ss: Annotated[FFI.CData, "const TSequenceSet *"],
    start: Annotated[FFI.CData, "const Interval *"],
    duration: Annotated[FFI.CData, "const Interval *"],
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_to_discrete(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequence *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_to_linear(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_to_step(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_to_tinstant(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TInstant *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_to_tsequence(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequence *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tinstant_merge(
    inst1: Annotated[FFI.CData, "const TInstant *"], inst2: Annotated[FFI.CData, "const TInstant *"]
) -> Annotated[FFI.CData, "Temporal *"]:
...
def tsequence_append_tinstant(
    seq: Annotated[FFI.CData, "TSequence *"],
    inst: Annotated[FFI.CData, "const TInstant *"],
    maxdist: float,
    maxt: Annotated[FFI.CData, "const Interval *"],
    expand: bool,
...
def tsequence_append_tsequence(
    seq1: Annotated[FFI.CData, "const TSequence *"], seq2: Annotated[FFI.CData, "const TSequence *"], expand: bool
) -> Annotated[FFI.CData, "Temporal *"]:
...
def tsequence_delete_timestamptz(
    seq: Annotated[FFI.CData, "const TSequence *"], t: int, connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tsequence_delete_tstzset(
    seq: Annotated[FFI.CData, "const TSequence *"], s: Annotated[FFI.CData, "const Set *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    s_converted = _ffi.cast("const Set *", s)
...
def tsequence_delete_tstzspan(
    seq: Annotated[FFI.CData, "const TSequence *"], s: Annotated[FFI.CData, "const Span *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    s_converted = _ffi.cast("const Span *", s)
...
def tsequence_delete_tstzspanset(
    seq: Annotated[FFI.CData, "const TSequence *"], ss: Annotated[FFI.CData, "const SpanSet *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tsequence_insert(
    seq1: Annotated[FFI.CData, "const TSequence *"], seq2: Annotated[FFI.CData, "const TSequence *"], connect: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    seq1_converted = _ffi.cast("const TSequence *", seq1)
    seq2_converted = _ffi.cast("const TSequence *", seq2)
...
def tsequence_merge(
    seq1: Annotated[FFI.CData, "const TSequence *"], seq2: Annotated[FFI.CData, "const TSequence *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    seq1_converted = _ffi.cast("const TSequence *", seq1)
    seq2_converted = _ffi.cast("const TSequence *", seq2)
...
def tsequenceset_append_tinstant(
    ss: Annotated[FFI.CData, "TSequenceSet *"],
    inst: Annotated[FFI.CData, "const TInstant *"],
    maxdist: float,
    maxt: Annotated[FFI.CData, "const Interval *"],
    expand: bool,
...
def tsequenceset_append_tsequence(
    ss: Annotated[FFI.CData, "TSequenceSet *"], seq: Annotated[FFI.CData, "const TSequence *"], expand: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("TSequenceSet *", ss)
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequenceset_delete_timestamptz(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], t: int
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tsequenceset_delete_tstzset(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], s: Annotated[FFI.CData, "const Set *"]
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    s_converted = _ffi.cast("const Set *", s)
...
def tsequenceset_delete_tstzspan(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], s: Annotated[FFI.CData, "const Span *"]
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    s_converted = _ffi.cast("const Span *", s)
...
def tsequenceset_delete_tstzspanset(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], ps: Annotated[FFI.CData, "const SpanSet *"]
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_insert(
    ss1: Annotated[FFI.CData, "const TSequenceSet *"], ss2: Annotated[FFI.CData, "const TSequenceSet *"]
) -> Annotated[FFI.CData, "TSequenceSet *"]:
...
def tsequence_expand_bbox(
    seq: Annotated[FFI.CData, "TSequence *"], inst: Annotated[FFI.CData, "const TInstant *"]
) -> Annotated[None, "void"]:
    seq_converted = _ffi.cast("TSequence *", seq)
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tsequence_set_bbox(
    seq: Annotated[FFI.CData, "const TSequence *"], box: Annotated[FFI.CData, "void *"]
) -> Annotated[None, "void"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    box_converted = _ffi.cast("void *", box)
...
def tsequenceset_expand_bbox(
    ss: Annotated[FFI.CData, "TSequenceSet *"], seq: Annotated[FFI.CData, "const TSequence *"]
) -> Annotated[None, "void"]:
    ss_converted = _ffi.cast("TSequenceSet *", ss)
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequenceset_set_bbox(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], box: Annotated[FFI.CData, "void *"]
) -> Annotated[None, "void"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    box_converted = _ffi.cast("void *", box)
...
def tdiscseq_restrict_minmax(
    seq: Annotated[FFI.CData, "const TSequence *"], min: bool, atfunc: bool
) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def temporal_restrict_minmax(
    temp: Annotated[FFI.CData, "const Temporal *"], min: bool, atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def temporal_restrict_values(
    temp: Annotated[FFI.CData, "const Temporal *"], set: Annotated[FFI.CData, "const Set *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    set_converted = _ffi.cast("const Set *", set)
...
def tinstant_restrict_tstzspan(
    inst: Annotated[FFI.CData, "const TInstant *"], period: Annotated[FFI.CData, "const Span *"], atfunc: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tinstant_restrict_tstzspanset(
    inst: Annotated[FFI.CData, "const TInstant *"], ss: Annotated[FFI.CData, "const SpanSet *"], atfunc: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tinstant_restrict_timestamptz(
    inst: Annotated[FFI.CData, "const TInstant *"], t: int, atfunc: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tinstant_restrict_tstzset(
    inst: Annotated[FFI.CData, "const TInstant *"], s: Annotated[FFI.CData, "const Set *"], atfunc: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    s_converted = _ffi.cast("const Set *", s)
...
def tinstant_restrict_value(
    inst: Annotated[FFI.CData, "const TInstant *"], value: Annotated[FFI.CData, "Datum"], atfunc: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    value_converted = _ffi.cast("Datum", value)
...
def tinstant_restrict_values(
    inst: Annotated[FFI.CData, "const TInstant *"], set: Annotated[FFI.CData, "const Set *"], atfunc: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    set_converted = _ffi.cast("const Set *", set)
...
def tnumber_restrict_span(
    temp: Annotated[FFI.CData, "const Temporal *"], span: Annotated[FFI.CData, "const Span *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    span_converted = _ffi.cast("const Span *", span)
...
def tnumberinst_restrict_span(
    inst: Annotated[FFI.CData, "const TInstant *"], span: Annotated[FFI.CData, "const Span *"], atfunc: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    span_converted = _ffi.cast("const Span *", span)
...
def tnumberseqset_restrict_span(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], span: Annotated[FFI.CData, "const Span *"], atfunc: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    span_converted = _ffi.cast("const Span *", span)
...
def tnumberseqset_restrict_spanset(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], spanset: Annotated[FFI.CData, "const SpanSet *"], atfunc: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequence_at_timestamptz(
    seq: Annotated[FFI.CData, "const TSequence *"], t: int
) -> Annotated[FFI.CData, "TInstant *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tsequence_restrict_tstzspan(
    seq: Annotated[FFI.CData, "const TSequence *"], s: Annotated[FFI.CData, "const Span *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    s_converted = _ffi.cast("const Span *", s)
...
def tsequence_restrict_tstzspanset(
    seq: Annotated[FFI.CData, "const TSequence *"], ss: Annotated[FFI.CData, "const SpanSet *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    ss_converted = _ffi.cast("const SpanSet *", ss)
...
def tsequenceset_restrict_minmax(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], min: bool, atfunc: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tsequenceset_restrict_tstzspan(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], s: Annotated[FFI.CData, "const Span *"], atfunc: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    s_converted = _ffi.cast("const Span *", s)
...
def tsequenceset_restrict_tstzspanset(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], ps: Annotated[FFI.CData, "const SpanSet *"], atfunc: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    ps_converted = _ffi.cast("const SpanSet *", ps)
...
def tsequenceset_restrict_timestamptz(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], t: int, atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    t_converted = _ffi.cast("TimestampTz", t)
...
def tsequenceset_restrict_tstzset(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], s: Annotated[FFI.CData, "const Set *"], atfunc: bool
) -> Annotated[FFI.CData, "Temporal *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    s_converted = _ffi.cast("const Set *", s)
...
def tsequenceset_restrict_value(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], value: Annotated[FFI.CData, "Datum"], atfunc: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    value_converted = _ffi.cast("Datum", value)
...
def always_eq_base_temporal(
    value: Annotated[FFI.CData, "Datum"], temp: Annotated[FFI.CData, "const Temporal *"]
) -> Annotated[int, "int"]:
    value_converted = _ffi.cast("Datum", value)
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def always_eq_temporal_base(
    temp: Annotated[FFI.CData, "const Temporal *"], value: Annotated[FFI.CData, "Datum"]
) -> Annotated[int, "int"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    value_converted = _ffi.cast("Datum", value)
...
def tnumberinst_abs(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tnumberseq_abs(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tnumberseq_delta_value(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tnumberseqset_abs(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tnumberseq_integral(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[float, "double"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tnumberseq_twavg(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[float, "double"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tnumberseqset_integral(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tnumberseqset_twavg(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def temporal_compact(temp: Annotated[FFI.CData, "const Temporal *"]) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tsequence_compact(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tsequenceset_compact(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def temporal_skiplist_make() -> Annotated[FFI.CData, "SkipList *"]:
...
def skiplist_search(
    list: Annotated[FFI.CData, "SkipList *"], key: Annotated[FFI.CData, "void *"], value: Annotated[FFI.CData, "void *"]
) -> Annotated[int, "int"]:
...
def skiplist_free(list: Annotated[FFI.CData, "SkipList *"]) -> Annotated[None, "void"]:
    list_converted = _ffi.cast("SkipList *", list)
...
def skiplist_splice(
    list: Annotated[FFI.CData, "SkipList *"],
    keys: Annotated[list, "void **"],
    values: Annotated[list, "void **"],
    count: int,
    func: Annotated[FFI.CData, "datum_func2"],
    crossings: bool,
    sktype: Annotated[FFI.CData, "SkipListType"],
) -> Annotated[None, "void"]:
    list_converted = _ffi.cast("SkipList *", list)
...
def skiplist_values(list: Annotated[FFI.CData, "SkipList *"]) -> Annotated[FFI.CData, "void **"]:
    list_converted = _ffi.cast("SkipList *", list)
...
def skiplist_keys_values(
    list: Annotated[FFI.CData, "SkipList *"], values: Annotated[list, "void **"]
) -> Annotated[FFI.CData, "void **"]:
    list_converted = _ffi.cast("SkipList *", list)
    values_converted = [_ffi.cast("void *", x) for x in values]
...
def temporal_app_tinst_transfn(
    state: Annotated[FFI.CData, "Temporal *"],
    inst: Annotated[FFI.CData, "const TInstant *"],
    interp: InterpolationType,
    maxdist: float,
    maxt: Annotated[FFI.CData, "const Interval *"],
...
def temporal_app_tseq_transfn(
    state: Annotated[FFI.CData, "Temporal *"], seq: Annotated[FFI.CData, "const TSequence *"]
) -> Annotated[FFI.CData, "Temporal *"]:
    state_converted = _ffi.cast("Temporal *", state)
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def span_bins(
    s: Annotated[FFI.CData, "const Span *"],
    size: Annotated[FFI.CData, "Datum"],
    origin: Annotated[FFI.CData, "Datum"],
    count: Annotated[FFI.CData, "int *"],
) -> Annotated[FFI.CData, "Span *"]:
    s_converted = _ffi.cast("const Span *", s)
    size_converted = _ffi.cast("Datum", size)
...
def tnumber_value_time_boxes(
    temp: Annotated[FFI.CData, "const Temporal *"],
    vsize: Annotated[FFI.CData, "Datum"],
    duration: Annotated[FFI.CData, "const Interval *"],
    vorigin: Annotated[FFI.CData, "Datum"],
    torigin: int,
    count: Annotated[FFI.CData, "int *"],
) -> Annotated[FFI.CData, "TBox *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def proj_get_context() -> Annotated[FFI.CData, "PJ_CONTEXT *"]:
...
def point_round(gs: Annotated[FFI.CData, "const GSERIALIZED *"], maxdd: int) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def gbox_set_stbox(
    box: Annotated[FFI.CData, "const GBOX *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[FFI.CData, "STBox *"]:
    box_converted = _ffi.cast("const GBOX *", box)
    srid_converted = _ffi.cast("int32_t", srid)
...
def geo_set_stbox(
    gs: Annotated[FFI.CData, "const GSERIALIZED *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[bool, "bool"]:
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    box_converted = _ffi.cast("STBox *", box)
...
def geoarr_set_stbox(
    values: Annotated[FFI.CData, "const Datum *"], count: int, box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    values_converted = _ffi.cast("const Datum *", values)
    box_converted = _ffi.cast("STBox *", box)
...
def spatial_set_stbox(
    d: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("Datum", d)
    basetype_converted = _ffi.cast("meosType", basetype)
    box_converted = _ffi.cast("STBox *", box)
...
def spatialset_set_stbox(
    set: Annotated[FFI.CData, "const Set *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    set_converted = _ffi.cast("const Set *", set)
    box_converted = _ffi.cast("STBox *", box)
...
def stbox_set_box3d(
    box: Annotated[FFI.CData, "const STBox *"], box3d: Annotated[FFI.CData, "BOX3D *"]
) -> Annotated[None, "void"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def stbox_set_gbox(
    box: Annotated[FFI.CData, "const STBox *"], gbox: Annotated[FFI.CData, "GBOX *"]
) -> Annotated[None, "void"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def tstzset_set_stbox(
    s: Annotated[FFI.CData, "const Set *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    s_converted = _ffi.cast("const Set *", s)
    box_converted = _ffi.cast("STBox *", box)
...
def tstzspan_set_stbox(
    s: Annotated[FFI.CData, "const Span *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    s_converted = _ffi.cast("const Span *", s)
    box_converted = _ffi.cast("STBox *", box)
...
def tstzspanset_set_stbox(
    s: Annotated[FFI.CData, "const SpanSet *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
...
def stbox_expand(
    box1: Annotated[FFI.CData, "const STBox *"], box2: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    box1_converted = _ffi.cast("const STBox *", box1)
...
def stbox_geo(box: Annotated[FFI.CData, "const STBox *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    box_converted = _ffi.cast("const STBox *", box)
...
def tgeogpointinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def tgeogpointseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def tgeogpointseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def tgeompointinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def tgeompointseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def tgeompointseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def tgeographyinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def tgeographyseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def tgeographyseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def tgeometryinst_in(string: str) -> Annotated[FFI.CData, "TInstant *"]:
    string_converted = string.encode("utf-8")
...
def tgeometryseq_in(string: str, interp: InterpolationType) -> Annotated[FFI.CData, "TSequence *"]:
    string_converted = string.encode("utf-8")
...
def tgeometryseqset_in(string: str) -> Annotated[FFI.CData, "TSequenceSet *"]:
    string_converted = string.encode("utf-8")
...
def tspatial_set_stbox(
    temp: Annotated[FFI.CData, "const Temporal *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
    box_converted = _ffi.cast("STBox *", box)
...
def tgeoinst_set_stbox(
    inst: Annotated[FFI.CData, "const TInstant *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
    box_converted = _ffi.cast("STBox *", box)
...
def tspatialseq_set_stbox(
    seq: Annotated[FFI.CData, "const TSequence *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    box_converted = _ffi.cast("STBox *", box)
...
def tspatialseqset_set_stbox(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], box: Annotated[FFI.CData, "STBox *"]
) -> Annotated[None, "void"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    box_converted = _ffi.cast("STBox *", box)
...
def spatial_set_srid(
    d: Annotated[FFI.CData, "Datum"], basetype: Annotated[FFI.CData, "meosType"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[bool, "bool"]:
    d_converted = _ffi.cast("Datum", d)
    basetype_converted = _ffi.cast("meosType", basetype)
    srid_converted = _ffi.cast("int32_t", srid)
...
def tspatialinst_srid(inst: Annotated[FFI.CData, "const TInstant *"]) -> Annotated[int, "int"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tpointseq_azimuth(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tpointseq_cumulative_length(
    seq: Annotated[FFI.CData, "const TSequence *"], prevlength: float
) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tpointseq_is_simple(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[bool, "bool"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tpointseq_length(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[float, "double"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tpointseq_linear_trajectory(
    seq: Annotated[FFI.CData, "const TSequence *"], unary_union: bool
) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tgeoseq_split_n_stboxes(
    seq: Annotated[FFI.CData, "const TSequence *"], max_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "STBox *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
    count_converted = _ffi.cast("int *", count)
...
def tpointseqset_azimuth(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tpointseqset_is_simple(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[bool, "bool"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tpointseqset_length(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[float, "double"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tgeoseqset_split_n_stboxes(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], max_count: int, count: Annotated[FFI.CData, "int *"]
) -> Annotated[FFI.CData, "STBox *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    count_converted = _ffi.cast("int *", count)
...
def tpoint_get_coord(temp: Annotated[FFI.CData, "const Temporal *"], coord: int) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeominst_tgeoginst(
    inst: Annotated[FFI.CData, "const TInstant *"], oper: bool
) -> Annotated[FFI.CData, "TInstant *"]:
    inst_converted = _ffi.cast("const TInstant *", inst)
...
def tgeomseq_tgeogseq(
    seq: Annotated[FFI.CData, "const TSequence *"], oper: bool
) -> Annotated[FFI.CData, "TSequence *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tgeomseqset_tgeogseqset(
    ss: Annotated[FFI.CData, "const TSequenceSet *"], oper: bool
) -> Annotated[FFI.CData, "TSequenceSet *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
...
def tgeom_tgeog(temp: Annotated[FFI.CData, "const Temporal *"], oper: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tgeo_tpoint(temp: Annotated[FFI.CData, "const Temporal *"], oper: bool) -> Annotated[FFI.CData, "Temporal *"]:
    temp_converted = _ffi.cast("const Temporal *", temp)
...
def tspatialinst_set_srid(
    inst: Annotated[FFI.CData, "TInstant *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[None, "void"]:
    inst_converted = _ffi.cast("TInstant *", inst)
    srid_converted = _ffi.cast("int32_t", srid)
...
def tspatialseq_set_srid(
    seq: Annotated[FFI.CData, "TSequence *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[None, "void"]:
    seq_converted = _ffi.cast("TSequence *", seq)
    srid_converted = _ffi.cast("int32_t", srid)
...
def tspatialseqset_set_srid(
    ss: Annotated[FFI.CData, "TSequenceSet *"], srid: Annotated[FFI.CData, "int32_t"]
) -> Annotated[None, "void"]:
    ss_converted = _ffi.cast("TSequenceSet *", ss)
    srid_converted = _ffi.cast("int32_t", srid)
...
def tpointseq_twcentroid(seq: Annotated[FFI.CData, "const TSequence *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def tpointseqset_twcentroid(ss: Annotated[FFI.CData, "const TSequenceSet *"]) -> Annotated[FFI.CData, "GSERIALIZED *"]:
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
