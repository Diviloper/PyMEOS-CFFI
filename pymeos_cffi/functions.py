...
def meos_set_spatial_ref_sys_csv(path: "const char*") -> None:
...
def set_split_each_n_spans(
    s: "const Set *", elems_per_span: int
) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast("const Set *", s)
    count = _ffi.new("int *")
...
def spanset_split_each_n_spans(
    ss: "const SpanSet *", elems_per_span: int
) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast("const SpanSet *", ss)
    count = _ffi.new("int *")
...
def temporal_time_bins(
    ...
    origin_converted = _ffi.cast("TimestampTz", origin)
    count = _ffi.new("int *")
    result = _lib.temporal_time_bins(
...
def tfloat_value_time_boxes(
    ...
    result = _lib.tfloat_value_time_boxes(
        temp_converted, vsize, duration_converted, vorigin, torigin_converted, count
    )
    _check_error()
    return result if result != _ffi.NULL else None, count[0]
...
def geo_transform_pipeline(
    gs: "const GSERIALIZED *", pipeline: str, srid_to: "int32_t", is_forward: bool
) -> "GSERIALIZED *":
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    pipeline_converted = pipeline.encode("utf-8")
    srid_to_converted = _ffi.cast("int32_t", srid_to)
    result = _lib.geo_transform_pipeline(
        gs_converted, pipeline_converted, srid_to_converted, is_forward
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def geom_shortestline2d(
    gs1: "const GSERIALIZED *", s2: "const GSERIALIZED *"
) -> "GSERIALIZED *":
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
...
def line_interpolate_point(
    gs: "GSERIALIZED *", distance_fraction: float, repeat: bool
) -> "GSERIALIZED *":
    gs_converted = _ffi.cast("GSERIALIZED *", gs)
...
def line_substring(
    gs: "const GSERIALIZED *", from_: float, to: float
) -> "GSERIALIZED *":
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def geog_intersects(
    gs1: "const GSERIALIZED *", gs2: "const GSERIALIZED *", use_spheroid: bool
) -> "bool":
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
    gs2_converted = _ffi.cast("const GSERIALIZED *", gs2)
...
def geom_dwithin2d(
    gs1: "const GSERIALIZED *", gs2: "const GSERIALIZED *", tolerance: float
) -> "bool":
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
    gs2_converted = _ffi.cast("const GSERIALIZED *", gs2)
...
def geom_relate_pattern(
    gs1: "const GSERIALIZED *", gs2: "const GSERIALIZED *", patt: str
) -> "bool":
    gs1_converted = _ffi.cast("const GSERIALIZED *", gs1)
    gs2_converted = _ffi.cast("const GSERIALIZED *", gs2)
...
def spatialset_transform_pipeline(
    s: "const Set *", pipelinestr: str, srid: "int32_t", is_forward: bool
) -> "Set *":
    s_converted = _ffi.cast("const Set *", s)
    pipelinestr_converted = pipelinestr.encode("utf-8")
    srid_converted = _ffi.cast("int32_t", srid)
    result = _lib.spatialset_transform_pipeline(
...
def stbox_transform_pipeline(
    box: "const STBox *", pipelinestr: str, srid: "int32_t", is_forward: bool
) -> "STBox *":
    box_converted = _ffi.cast("const STBox *", box)
    pipelinestr_converted = pipelinestr.encode("utf-8")
    srid_converted = _ffi.cast("int32_t", srid)
...
def rtree_search(
    rtree: "const RTree *", query: "const STBox *"
) -> "Tuple['int *', 'int']":
...
def tspatial_transform_pipeline(
    temp: "const Temporal *", pipelinestr: str, srid: "int32_t", is_forward: bool
) -> "Temporal *":
    temp_converted = _ffi.cast("const Temporal *", temp)
    pipelinestr_converted = pipelinestr.encode("utf-8")
    srid_converted = _ffi.cast("int32_t", srid)
    result = _lib.tspatial_transform_pipeline(
...
def tpoint_at_geom(
    temp: "const Temporal *", gs: "const GSERIALIZED *", zspan: "const Span *"
) -> "Temporal *":
    temp_converted = _ffi.cast("const Temporal *", temp)
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
...
def tcontains_tgeo_tgeo(
    temp1: "const Temporal *", temp2: "const Temporal *", restr: bool, atvalue: bool
) -> "Temporal *":
    temp1_converted = _ffi.cast("const Temporal *", temp1)
    temp2_converted = _ffi.cast("const Temporal *", temp2)
...
def tdwithin_tgeo_tgeo(
    ...
    temp1_converted = _ffi.cast("const Temporal *", temp1)
    temp2_converted = _ffi.cast("const Temporal *", temp2)
    result = _lib.tdwithin_tgeo_tgeo(
...
def tintersects_tgeo_tgeo(
    ...
    temp1_converted = _ffi.cast("const Temporal *", temp1)
    temp2_converted = _ffi.cast("const Temporal *", temp2)
    result = _lib.tintersects_tgeo_tgeo(
        temp1_converted, temp2_converted, restr, atvalue
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def geo_cluster_dbscan(
    geoms: "const GSERIALIZED **", ngeoms: "uint32_t", tolerance: float, minpoints: int
) -> "uint32_t *":
    geoms_converted = [_ffi.cast("const GSERIALIZED *", x) for x in geoms]
    ngeoms_converted = _ffi.cast("uint32_t", ngeoms)
    result = _lib.geo_cluster_dbscan(
        geoms_converted, ngeoms_converted, tolerance, minpoints
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def geo_cluster_within(
    geoms: "const GSERIALIZED **", ngeoms: "uint32_t", tolerance: float
) -> "Tuple['GSERIALIZED **', 'int']":
    geoms_converted = [_ffi.cast("const GSERIALIZED *", x) for x in geoms]
    ngeoms_converted = _ffi.cast("uint32_t", ngeoms)
    count = _ffi.new("int *")
    result = _lib.geo_cluster_within(
        geoms_converted, ngeoms_converted, tolerance, count
    )
    _check_error()
    return result if result != _ffi.NULL else None, count[0]
...
def tbox_expand_value(
    box: "const TBox *", value: "Datum", basetyp: "meosType"
) -> "TBox *":
    box_converted = _ffi.cast("const TBox *", box)
    value_converted = _ffi.cast("Datum", value)
...
def tsequence_from_base_temp(
    value: "Datum", temptype: "meosType", seq: "const TSequence *"
) -> "TSequence *":
    value_converted = _ffi.cast("Datum", value)
    temptype_converted = _ffi.cast("meosType", temptype)
    seq_converted = _ffi.cast("const TSequence *", seq)
    result = _lib.tsequence_from_base_temp(
        value_converted, temptype_converted, seq_converted
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequence_from_base_tstzset(
    value: "Datum", temptype: "meosType", s: "const Set *"
) -> "TSequence *":
    value_converted = _ffi.cast("Datum", value)
    temptype_converted = _ffi.cast("meosType", temptype)
    s_converted = _ffi.cast("const Set *", s)
    result = _lib.tsequence_from_base_tstzset(
        value_converted, temptype_converted, s_converted
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequenceset_from_base_temp(
    value: "Datum", temptype: "meosType", ss: "const TSequenceSet *"
) -> "TSequenceSet *":
    value_converted = _ffi.cast("Datum", value)
    temptype_converted = _ffi.cast("meosType", temptype)
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    result = _lib.tsequenceset_from_base_temp(
...
def span_bins(
    s: "const Span *", size: "Datum", origin: "Datum"
) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast("const Span *", s)
    size_converted = _ffi.cast("Datum", size)
...
def spanset_bins(
    ss: "const SpanSet *", size: "Datum", origin: "Datum"
) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast("const SpanSet *", ss)
    size_converted = _ffi.cast("Datum", size)
    origin_converted = _ffi.cast("Datum", origin)
...
def tnumber_value_bins(
    ...
    origin_converted = _ffi.cast("Datum", origin)
    count = _ffi.new("int *")
    result = _lib.tnumber_value_bins(
...
def tgeo_restrict_geom(
    ...
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    zspan_converted = _ffi.cast("const Span *", zspan)
    result = _lib.tgeo_restrict_geom(
        temp_converted, gs_converted, zspan_converted, atfunc
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def tgeoinst_restrict_geom(
    ...
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    zspan_converted = _ffi.cast("const Span *", zspan)
    result = _lib.tgeoinst_restrict_geom(
        inst_converted, gs_converted, zspan_converted, atfunc
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def tgeoinst_restrict_stbox(
    ...
    inst_converted = _ffi.cast("const TInstant *", inst)
    box_converted = _ffi.cast("const STBox *", box)
    result = _lib.tgeoinst_restrict_stbox(
...
def tgeoseq_restrict_geom(
    ...
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    zspan_converted = _ffi.cast("const Span *", zspan)
    result = _lib.tgeoseq_restrict_geom(
        seq_converted, gs_converted, zspan_converted, atfunc
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def tgeoseq_restrict_stbox(
    ...
    seq_converted = _ffi.cast("const TSequence *", seq)
    box_converted = _ffi.cast("const STBox *", box)
    result = _lib.tgeoseq_restrict_stbox(
...
def tgeoseqset_restrict_geom(
    ...
    gs_converted = _ffi.cast("const GSERIALIZED *", gs)
    zspan_converted = _ffi.cast("const Span *", zspan)
    result = _lib.tgeoseqset_restrict_geom(
        ss_converted, gs_converted, zspan_converted, atfunc
    )
    _check_error()
    return result if result != _ffi.NULL else None
...
def tgeoseqset_restrict_stbox(
    ...
    ss_converted = _ffi.cast("const TSequenceSet *", ss)
    box_converted = _ffi.cast("const STBox *", box)
    result = _lib.tgeoseqset_restrict_stbox(
...
def tpointseq_linear_trajectory(
    seq: "const TSequence *", unary_union: bool
) -> "GSERIALIZED *":
    seq_converted = _ffi.cast("const TSequence *", seq)
...
def npoint_as_wkb(
    np: "const Npoint *", variant: int
) -> "Tuple['uint8_t *', 'size_t *']":
    np_converted = _ffi.cast("const Npoint *", np)
    variant_converted = _ffi.cast("uint8_t", variant)
    size_out = _ffi.new("size_t *")
...
def tnpoint_minus_npoint(
    temp: "const Temporal *", np: "const Npoint *"
) -> "Temporal *":
    temp_converted = _ffi.cast("const Temporal *", temp)
    np_converted = _ffi.cast("const Npoint *", np)
