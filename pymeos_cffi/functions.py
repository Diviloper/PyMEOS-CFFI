...
def meos_finalize_projsrs() -> None:
    _lib.meos_finalize_projsrs()
    _check_error()


def meos_finalize_ways() -> None:
...
def float_exp(d: float) -> 'double':
    result = _lib.float_exp(d)
    _check_error()
    return result if result != _ffi.NULL else None


def float_ln(d: float) -> 'double':
    result = _lib.float_ln(d)
    _check_error()
    return result if result != _ffi.NULL else None


def float_log10(d: float) -> 'double':
    result = _lib.float_log10(d)
    _check_error()
    return result if result != _ffi.NULL else None


def float_round(d: float, maxdd: int) -> 'double':
...
def mul_interval_double(interv: 'const Interval *', factor: float) -> 'Interval *':
    interv_converted = _ffi.cast('const Interval *', interv)
...
def timestamptz_shift(t: int, interv: 'const Interval *') -> 'TimestampTz':
    t_converted = _ffi.cast('TimestampTz', t)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def spanset_make(spans: 'List[Span *]') -> 'SpanSet *':
...
def floatspan_degrees(s: 'const Span *', normalize: bool) -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
...
def floatspan_radians(s: 'const Span *') -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
...
def floatspanset_degrees(ss: 'const SpanSet *', normalize: bool) -> 'SpanSet *':
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def floatspanset_radians(ss: 'const SpanSet *') -> 'SpanSet *':
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def numspan_expand(s: 'const Span *', value: 'Datum') -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
...
def tstzspan_expand(s: 'const Span *', interv: 'const Interval *') -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def set_round(s: 'const Set *', maxdd: int) -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
...
def set_split_each_n_spans(s: 'const Set *', elems_per_span: int) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Set *', s)
    count = _ffi.new('int *')
...
def spanset_split_each_n_spans(ss: 'const SpanSet *', elems_per_span: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count = _ffi.new('int *')
...
def intersection_date_set(d: 'DateADT', s: 'const Set *') -> 'Set *':
    d_converted = _ffi.cast('DateADT', d)
    s_converted = _ffi.cast('const Set *', s)
...
def union_date_set(d: 'DateADT', s: 'const Set *') -> 'Set *':
    d_converted = _ffi.cast('DateADT', d)
    s_converted = _ffi.cast('const Set *', s)
...
def tbox_expand_float(box: 'const TBox *', d: float) -> 'TBox *':
    box_converted = _ffi.cast('const TBox *', box)
...
def tbox_expand_int(box: 'const TBox *', i: int) -> 'TBox *':
    box_converted = _ffi.cast('const TBox *', box)
...
def tbool_to_tint(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temparr_round(temp: 'const Temporal **', count: int, maxdd: int) -> 'Temporal **':
...
def temporal_round(temp: 'const Temporal *', maxdd: int) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_append_tinstant(temp: 'Temporal *', inst: 'const TInstant *', interp: 'interpType', maxdist: float, maxt: "Optional['const Interval *']", expand: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('Temporal *', temp)
    inst_converted = _ffi.cast('const TInstant *', inst)
    interp_converted = _ffi.cast('interpType', interp)
    maxt_converted = _ffi.cast('const Interval *', maxt) if maxt is not None else _ffi.NULL
    result = _lib.temporal_append_tinstant(temp_converted, inst_converted, interp_converted, maxdist, maxt_converted, expand)
    _check_error()
    return result if result != _ffi.NULL else None
...
def temporal_derivative(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_exp(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_ln(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_log10(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def float_angular_difference(degrees1: float, degrees2: float) -> 'double':
...
def tdistance_tfloat_float(temp: 'const Temporal *', d: float) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tdistance_tint_int(temp: 'const Temporal *', i: int) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tdistance_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_time_bins(temp: 'const Temporal *', duration: 'const Interval *', origin: int) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    origin_converted = _ffi.cast('TimestampTz', origin)
    count = _ffi.new('int *')
...
def tfloat_time_boxes(temp: 'const Temporal *', duration: 'const Interval *', torigin: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def tfloat_value_bins(temp: 'const Temporal *', vsize: float, vorigin: float) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tfloat_value_boxes(temp: 'const Temporal *', vsize: float, vorigin: float) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tfloat_value_split(temp: 'const Temporal *', size: float, origin: float, bins: 'double **') -> "Tuple['Temporal **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    bins_converted = [_ffi.cast('double *', x) for x in bins]
    count = _ffi.new('int *')
    result = _lib.tfloat_value_split(temp_converted, size, origin, bins_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tfloat_value_time_boxes(temp: 'const Temporal *', vsize: float, duration: 'const Interval *', vorigin: float, torigin: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def tint_time_boxes(temp: 'const Temporal *', duration: 'const Interval *', torigin: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def tint_value_bins(temp: 'const Temporal *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tint_value_boxes(temp: 'const Temporal *', vsize: int, vorigin: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tint_value_time_boxes(temp: 'const Temporal *', vsize: int, duration: 'const Interval *', vorigin: int, torigin: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def type_span_bbox(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def span_tbox_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def ensure_span_tbox_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def tpoint_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def ensure_tpoint_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def tgeo_type_all(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def ensure_tgeo_type_all(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def tgeometry_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def ensure_tgeometry_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def tgeodetic_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def ensure_tgeodetic_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def ensure_tnumber_tpoint_type(type: 'meosType') -> 'bool':
    type_converted = _ffi.cast('meosType', type)
...
def geo_as_ewkb(gs: 'const GSERIALIZED *', endian: str, size: 'size_t *') -> 'uint8_t *':
...
def geo_as_geojson(gs: 'const GSERIALIZED *', option: int, precision: int, srs: str) -> str:
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geo_from_ewkb(wkb: 'const uint8_t *', wkb_size: 'size_t', srid: int) -> 'GSERIALIZED *':
...
def geo_from_text(wkt: str, srid: 'int32_t') -> 'GSERIALIZED *':
...
def geog_from_binary(wkb_bytea: str) -> 'GSERIALIZED *':
...
def geog_from_hexewkb(wkt: str) -> 'GSERIALIZED *':
    wkt_converted = wkt.encode('utf-8')
...
def geog_in(string: str, typmod: int) -> 'GSERIALIZED *':
    string_converted = string.encode('utf-8')
    typmod_converted = _ffi.cast('int32', typmod)
...
def geom_from_hexewkb(wkt: str) -> 'GSERIALIZED *':
    wkt_converted = wkt.encode('utf-8')
...
def geom_in(string: str, typmod: int) -> 'GSERIALIZED *':
    string_converted = string.encode('utf-8')
    typmod_converted = _ffi.cast('int32', typmod)
...
def geo_copy(g: 'const GSERIALIZED *') -> 'GSERIALIZED *':
...
def geogpoint_make2d(srid: 'int32_t', x: float, y: float) -> 'GSERIALIZED *':
    srid_converted = _ffi.cast('int32_t', srid)
...
def geogpoint_make3dz(srid: 'int32_t', x: float, y: float, z: float) -> 'GSERIALIZED *':
    srid_converted = _ffi.cast('int32_t', srid)
...
def geompoint_make2d(srid: 'int32_t', x: float, y: float) -> 'GSERIALIZED *':
    srid_converted = _ffi.cast('int32_t', srid)
...
def geompoint_make3dz(srid: 'int32_t', x: float, y: float, z: float) -> 'GSERIALIZED *':
    srid_converted = _ffi.cast('int32_t', srid)
...
def geom_to_geog(geom: 'const GSERIALIZED *') -> 'GSERIALIZED *':
...
def geog_to_geom(geog: 'const GSERIALIZED *') -> 'GSERIALIZED *':
...
def geo_is_empty(g: 'const GSERIALIZED *') -> 'bool':
    g_converted = _ffi.cast('const GSERIALIZED *', g)
...
def geog_area(g: 'const GSERIALIZED *', use_spheroid: bool) -> 'double':
    g_converted = _ffi.cast('const GSERIALIZED *', g)
...
def geog_centroid(g: 'const GSERIALIZED *', use_spheroid: bool) -> 'GSERIALIZED *':
    g_converted = _ffi.cast('const GSERIALIZED *', g)
...
def geog_length(g: 'const GSERIALIZED *', use_spheroid: bool) -> 'double':
    g_converted = _ffi.cast('const GSERIALIZED *', g)
...
def geog_perimeter(g: 'const GSERIALIZED *', use_spheroid: bool) -> 'double':
    g_converted = _ffi.cast('const GSERIALIZED *', g)
...
def geom_azimuth(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'double':
...
def geom_length(gs: 'const GSERIALIZED *') -> 'double':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geom_perimeter(gs: 'const GSERIALIZED *') -> 'double':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def line_numpoints(gs: 'const GSERIALIZED *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def line_point_n(geom: 'const GSERIALIZED *', n: int) -> 'GSERIALIZED *':
    geom_converted = _ffi.cast('const GSERIALIZED *', geom)
...
def geo_reverse(gs: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geo_round(gs: 'const GSERIALIZED *', maxdd: int) -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geo_set_srid(gs: 'const GSERIALIZED *', srid: 'int32_t') -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    srid_converted = _ffi.cast('int32_t', srid)
...
def geo_srid(gs: 'const GSERIALIZED *') -> 'int32_t':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geo_transform(geom: 'GSERIALIZED *', srid_to: 'int32_t') -> 'GSERIALIZED *':
...
def geo_transform_pipeline(gs: 'const GSERIALIZED *', pipeline: str, srid_to: 'int32_t', is_forward: bool) -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geo_collect_garray(gsarr: 'GSERIALIZED **', count: int) -> 'GSERIALIZED *':
...
def geo_makeline_garray(gsarr: 'GSERIALIZED **', count: int) -> 'GSERIALIZED *':
    gsarr_converted = [_ffi.cast('GSERIALIZED *', x) for x in gsarr]
...
def geo_npoints(gs: 'const GSERIALIZED *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geo_ngeos(gs: 'const GSERIALIZED *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geo_geoN(geom: 'const GSERIALIZED *', n: int) -> 'GSERIALIZED *':
    geom_converted = _ffi.cast('const GSERIALIZED *', geom)
...
def geom_array_union(gsarr: 'GSERIALIZED **', count: int) -> 'GSERIALIZED *':
    gsarr_converted = [_ffi.cast('GSERIALIZED *', x) for x in gsarr]
...
def geom_boundary(gs: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geom_buffer(gs: 'const GSERIALIZED *', size: float, params: str) -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geom_centroid(gs: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geom_convex_hull(gs: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geom_difference2d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_intersection2d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_shortestline2d(gs1: 'const GSERIALIZED *', s2: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
...
def geom_shortestline3d(gs1: 'const GSERIALIZED *', s2: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    s2_converted = _ffi.cast('const GSERIALIZED *', s2)
...
def geom_unary_union(gs: 'GSERIALIZED *', prec: float) -> 'GSERIALIZED *':
...
def line_interpolate_point(gs: 'GSERIALIZED *', distance_fraction: float, repeat: bool) -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('GSERIALIZED *', gs)
...
def line_locate_point(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'double':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def line_substring(gs: 'const GSERIALIZED *', from_: float, to: float) -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geog_dwithin(g1: 'const GSERIALIZED *', g2: 'const GSERIALIZED *', tolerance: float, use_spheroid: bool) -> 'bool':
...
def geog_intersects(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *', use_spheroid: bool) -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_contains(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_covers(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_disjoint2d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_dwithin2d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *', tolerance: float) -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_dwithin3d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *', tolerance: float) -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_intersects2d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_intersects3d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_relate_pattern(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *', patt: str) -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_touches(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'bool':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geo_stboxes(gs: 'const GSERIALIZED *') -> "Tuple['STBox *', 'int']":
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    count = _ffi.new('int *')
...
def geo_split_each_n_stboxes(gs: 'const GSERIALIZED *', elem_count: int) -> "Tuple['STBox *', 'int']":
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    count = _ffi.new('int *')
...
def geo_split_n_stboxes(gs: 'const GSERIALIZED *', box_count: int) -> "Tuple['STBox *', 'int']":
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    count = _ffi.new('int *')
...
def geog_distance(g1: 'const GSERIALIZED *', g2: 'const GSERIALIZED *') -> 'double':
    g1_converted = _ffi.cast('const GSERIALIZED *', g1)
    g2_converted = _ffi.cast('const GSERIALIZED *', g2)
...
def geom_distance2d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'double':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geom_distance3d(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'double':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def geo_equals(gs1: 'const GSERIALIZED *', gs2: 'const GSERIALIZED *') -> 'int':
    gs1_converted = _ffi.cast('const GSERIALIZED *', gs1)
    gs2_converted = _ffi.cast('const GSERIALIZED *', gs2)
...
def spatialset_as_text(set: 'const Set *', maxdd: int) -> str:
    set_converted = _ffi.cast('const Set *', set)
...
def spatialset_as_ewkt(set: 'const Set *', maxdd: int) -> str:
    set_converted = _ffi.cast('const Set *', set)
...
def geo_to_set(gs: 'const GSERIALIZED *') -> 'Set *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def contained_geo_set(gs: 'const GSERIALIZED *', s: 'const Set *') -> 'bool':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def geo_union_transfn(state: 'Set *', gs: 'const GSERIALIZED *') -> 'Set *':
    state_converted = _ffi.cast('Set *', state)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def spatialset_set_srid(s: 'const Set *', srid: 'int32_t') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    srid_converted = _ffi.cast('int32_t', srid)
...
def spatialset_transform(s: 'const Set *', srid: 'int32_t') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    srid_converted = _ffi.cast('int32_t', srid)
...
def spatialset_transform_pipeline(s: 'const Set *', pipelinestr: str, srid: 'int32_t', is_forward: bool) -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
...
def rtree_insert(rtree: 'RTree *', box: 'STBox *', id: int) -> None:
    rtree_converted = _ffi.cast('RTree *', rtree)
...
def rtree_search(rtree: 'const RTree *', query: 'const STBox *') -> "Tuple['int *', 'int']":
...
def tgeo_out(temp: 'const Temporal *', maxdd: int) -> str:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeography_from_mfjson(mfjson: str) -> 'Temporal *':
...
def tgeography_in(string: str) -> 'Temporal *':
    string_converted = string.encode('utf-8')
...
def tgeometry_from_mfjson(string: str) -> 'Temporal *':
    string_converted = string.encode('utf-8')
...
def tgeometry_in(string: str) -> 'Temporal *':
    string_converted = string.encode('utf-8')
...
def tspatial_as_ewkt(temp: 'const Temporal *', maxdd: int) -> str:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tspatial_as_text(temp: 'const Temporal *', maxdd: int) -> str:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_from_base_temp(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeoinst_make(gs: 'const GSERIALIZED *', t: int) -> 'TInstant *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    t_converted = _ffi.cast('TimestampTz', t)
...
def tgeoseq_from_base_tstzset(gs: 'const GSERIALIZED *', s: 'const Set *') -> 'TSequence *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def tgeoseq_from_base_tstzspan(gs: 'const GSERIALIZED *', s: 'const Span *', interp: 'interpType') -> 'TSequence *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    s_converted = _ffi.cast('const Span *', s)
    interp_converted = _ffi.cast('interpType', interp)
    result = _lib.tgeoseq_from_base_tstzspan(gs_converted, s_converted, interp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tgeoseqset_from_base_tstzspanset(gs: 'const GSERIALIZED *', ss: 'const SpanSet *', interp: 'interpType') -> 'TSequenceSet *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    ss_converted = _ffi.cast('const SpanSet *', ss)
    interp_converted = _ffi.cast('interpType', interp)
    result = _lib.tgeoseqset_from_base_tstzspanset(gs_converted, ss_converted, interp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tgeogpoint_to_tgeography(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeography_to_tgeogpoint(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeography_to_tgeometry(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeometry_to_tgeography(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeometry_to_tgeompoint(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeompoint_to_tgeometry(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tpoint_as_mvtgeom(temp: 'const Temporal *', bounds: 'const STBox *', extent: 'int32_t', buffer: 'int32_t', clip_geom: bool, gsarr: 'GSERIALIZED **', timesarr: 'int64 **') -> "Tuple['bool', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tspatial_to_stbox(temp: 'const Temporal *') -> 'STBox *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_centroid(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_convex_hull(temp: 'const Temporal *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_end_value(temp: 'const Temporal *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_start_value(temp: 'const Temporal *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_value_at_timestamptz(temp: 'const Temporal *', t: int, strict: bool, value: 'GSERIALIZED **') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
    value_converted = [_ffi.cast('GSERIALIZED *', x) for x in value]
    result = _lib.tgeo_value_at_timestamptz(temp_converted, t_converted, strict, value_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tgeo_values(temp: 'const Temporal *') -> "Tuple['GSERIALIZED **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tgeo_affine(temp: 'const Temporal *', a: 'const AFFINE *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_scale(temp: 'const Temporal *', scale: 'const GSERIALIZED *', sorigin: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tspatial_srid(temp: 'const Temporal *') -> 'int32_t':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tspatial_set_srid(temp: 'const Temporal *', srid: 'int32_t') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tspatial_transform(temp: 'const Temporal *', srid: 'int32_t') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tspatial_transform_pipeline(temp: 'const Temporal *', pipelinestr: str, srid: 'int32_t', is_forward: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
...
def tgeo_at_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tgeo_at_stbox(temp: 'const Temporal *', box: 'const STBox *', border_inc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeo_at_value(temp: 'const Temporal *', gs: 'GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('GSERIALIZED *', gs)
...
def tgeo_minus_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tgeo_minus_stbox(temp: 'const Temporal *', box: 'const STBox *', border_inc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeo_minus_value(temp: 'const Temporal *', gs: 'GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('GSERIALIZED *', gs)
...
def always_eq_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def always_eq_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def always_ne_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def ever_eq_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def ever_ne_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def teq_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tne_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tne_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tgeo_stboxes(temp: 'const Temporal *') -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tgeo_space_boxes(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, sorigin: 'const GSERIALIZED *', bitmatrix: bool, border_inc: bool) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    count = _ffi.new('int *')
...
def tgeo_space_time_boxes(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, duration: 'const Interval *', sorigin: 'const GSERIALIZED *', torigin: int, bitmatrix: bool, border_inc: bool) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def tgeo_split_each_n_stboxes(temp: 'const Temporal *', elem_count: int) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tgeo_split_n_stboxes(temp: 'const Temporal *', box_count: int) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def adjacent_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def adjacent_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def adjacent_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contained_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contained_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def contained_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contains_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def contains_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def contains_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overlaps_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overlaps_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overlaps_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def same_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def same_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def same_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def above_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def above_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def above_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def after_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def after_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def after_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def back_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def back_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def back_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def before_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def before_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def before_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def below_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def below_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def below_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def front_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def front_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def front_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def left_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def left_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def left_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overabove_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overabove_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overabove_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overafter_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overafter_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overafter_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overback_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overback_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overback_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbefore_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overbefore_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overbefore_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbelow_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overbelow_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overbelow_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overfront_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overfront_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overfront_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overleft_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overleft_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overleft_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overright_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def overright_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def overright_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def right_stbox_tspatial(box: 'const STBox *', temp: 'const Temporal *') -> 'bool':
    box_converted = _ffi.cast('const STBox *', box)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def right_tspatial_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def right_tspatial_tspatial(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def acontains_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def acontains_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def acontains_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adisjoint_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def adisjoint_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adwithin_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', dist: float) -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def adwithin_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', dist: float) -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def aintersects_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def aintersects_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def atouches_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def atouches_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def econtains_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def econtains_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def econtains_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ecovers_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ecovers_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def ecovers_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def edisjoint_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def edisjoint_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def edwithin_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', dist: float) -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def edwithin_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', dist: float) -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def eintersects_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def eintersects_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def etouches_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def etouches_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tcontains_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tcontains_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tcontains_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tcovers_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tcovers_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tcovers_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tdisjoint_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tdisjoint_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tdisjoint_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tdwithin_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *', dist: float, restr: bool, atvalue: bool) -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tdwithin_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', dist: float, restr: bool, atvalue: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tdwithin_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', dist: float, restr: bool, atvalue: bool) -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tintersects_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tintersects_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tintersects_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ttouches_geo_tgeo(gs: 'const GSERIALIZED *', temp: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ttouches_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def ttouches_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *', restr: bool, atvalue: bool) -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tdistance_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tdistance_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def nad_tgeo_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'double':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'TInstant *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def nai_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'TInstant *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_tgeo_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def shortestline_tgeo_tgeo(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'GSERIALIZED *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tgeo_space_split(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, sorigin: 'const GSERIALIZED *', bitmatrix: bool, border_inc: bool, space_bins: 'GSERIALIZED ***') -> "Tuple['Temporal **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    space_bins_converted = [_ffi.cast('GSERIALIZED **', x) for x in space_bins]
    count = _ffi.new('int *')
    result = _lib.tgeo_space_split(temp_converted, xsize, ysize, zsize, sorigin_converted, bitmatrix, border_inc, space_bins_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tgeo_space_time_split(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, duration: 'const Interval *', sorigin: 'const GSERIALIZED *', torigin: int, bitmatrix: bool, border_inc: bool, space_bins: 'GSERIALIZED ***', time_bins: 'TimestampTz **') -> "Tuple['Temporal **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    ...
    count = _ffi.new('int *')
    result = _lib.tgeo_space_time_split(temp_converted, xsize, ysize, zsize, duration_converted, sorigin_converted, torigin_converted, bitmatrix, border_inc, space_bins_converted, time_bins_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def geo_cluster_kmeans(geoms: 'const GSERIALIZED **', ngeoms: 'uint32_t', k: 'uint32_t') -> 'int *':
...
def geo_cluster_dbscan(geoms: 'const GSERIALIZED **', ngeoms: 'uint32_t', tolerance: float, minpoints: int) -> 'uint32_t *':
    geoms_converted = [_ffi.cast('const GSERIALIZED *', x) for x in geoms]
    ngeoms_converted = _ffi.cast('uint32_t', ngeoms)
...
def geo_cluster_intersecting(geoms: 'const GSERIALIZED **', ngeoms: 'uint32_t') -> "Tuple['GSERIALIZED **', 'int']":
    geoms_converted = [_ffi.cast('const GSERIALIZED *', x) for x in geoms]
    ngeoms_converted = _ffi.cast('uint32_t', ngeoms)
    count = _ffi.new('int *')
...
def geo_cluster_within(geoms: 'const GSERIALIZED **', ngeoms: 'uint32_t', tolerance: float) -> "Tuple['GSERIALIZED **', 'int']":
    geoms_converted = [_ffi.cast('const GSERIALIZED *', x) for x in geoms]
    ngeoms_converted = _ffi.cast('uint32_t', ngeoms)
    count = _ffi.new('int *')
...
def floatspan_round_set(s: 'const Span *', maxdd: int) -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
...
def value_set(d: 'Datum', basetype: 'meosType') -> 'Set *':
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def value_span(d: 'Datum', basetype: 'meosType') -> 'Span *':
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def value_spanset(d: 'Datum', basetype: 'meosType') -> 'SpanSet *':
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def tbox_expand_value(box: 'const TBox *', value: 'Datum', basetyp: 'meosType') -> 'TBox *':
    box_converted = _ffi.cast('const TBox *', box)
    value_converted = _ffi.cast('Datum', value)
...
def union_set_value(s: 'const Set *', value: 'Datum') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    value_converted = _ffi.cast('Datum', value)
...
def union_value_set(value: 'Datum', s: 'const Set *') -> 'Set *':
    value_converted = _ffi.cast('Datum', value)
    s_converted = _ffi.cast('const Set *', s)
...
def number_tbox(value: 'Datum', basetype: 'meosType') -> 'TBox *':
    value_converted = _ffi.cast('Datum', value)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def tsequence_from_base_temp(value: 'Datum', temptype: 'meosType', seq: 'const TSequence *') -> 'TSequence *':
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('meosType', temptype)
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_from_base_tstzset(value: 'Datum', temptype: 'meosType', s: 'const Set *') -> 'TSequence *':
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('meosType', temptype)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequenceset_from_base_temp(value: 'Datum', temptype: 'meosType', ss: 'const TSequenceSet *') -> 'TSequenceSet *':
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('meosType', temptype)
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def temporal_end_inst(temp: 'const Temporal *') -> 'const TInstant *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_inst_n(temp: 'const Temporal *', n: int) -> 'const TInstant *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_instants_p(temp: 'const Temporal *') -> "Tuple['const TInstant **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
    result = _lib.temporal_instants_p(temp_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]
...
def temporal_sequences_p(temp: 'const Temporal *') -> "Tuple['const TSequence **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def temporal_start_inst(temp: 'const Temporal *') -> 'const TInstant *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def temporal_values_p(temp: 'const Temporal *') -> "Tuple['Datum *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tinstant_value_p(inst: 'const TInstant *') -> 'Datum':
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tinstant_values_p(inst: 'const TInstant *') -> "Tuple['Datum *', 'int']":
    inst_converted = _ffi.cast('const TInstant *', inst)
    count = _ffi.new('int *')
...
def tsequence_insts_p(seq: 'const TSequence *') -> 'const TInstant **':
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tsequence_values_p(seq: 'const TSequence *') -> "Tuple['Datum *', 'int']":
    seq_converted = _ffi.cast('const TSequence *', seq)
    count = _ffi.new('int *')
...
def tsequenceset_insts_p(ss: 'const TSequenceSet *') -> 'const TInstant **':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tsequenceset_values_p(ss: 'const TSequenceSet *') -> "Tuple['Datum *', 'int']":
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    count = _ffi.new('int *')
...
def tdistance_tnumber_number(temp: 'const Temporal *', value: 'Datum') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def nad_tnumber_number(temp: 'const Temporal *', value: 'Datum') -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
    value_converted = _ffi.cast('Datum', value)
...
def nad_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'double':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_app_tinst_transfn(state: 'Temporal *', inst: 'const TInstant *', interp: 'interpType', maxdist: float, maxt: 'const Interval *') -> 'Temporal *':
    state_converted = _ffi.cast('Temporal *', state)
    inst_converted = _ffi.cast('const TInstant *', inst)
    interp_converted = _ffi.cast('interpType', interp)
    maxt_converted = _ffi.cast('const Interval *', maxt)
    result = _lib.temporal_app_tinst_transfn(state_converted, inst_converted, interp_converted, maxdist, maxt_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def span_bins(s: 'const Span *', size: 'Datum', origin: 'Datum') -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Span *', s)
    size_converted = _ffi.cast('Datum', size)
...
def spanset_bins(ss: 'const SpanSet *', size: 'Datum', origin: 'Datum') -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    size_converted = _ffi.cast('Datum', size)
    origin_converted = _ffi.cast('Datum', origin)
    count = _ffi.new('int *')
...
def tnumber_value_bins(temp: 'const Temporal *', size: 'Datum', origin: 'Datum') -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    size_converted = _ffi.cast('Datum', size)
    origin_converted = _ffi.cast('Datum', origin)
    count = _ffi.new('int *')
...
def datum_geo_round(value: 'Datum', size: 'Datum') -> 'Datum':
    value_converted = _ffi.cast('Datum', value)
    size_converted = _ffi.cast('Datum', size)
...
def point_round(gs: 'const GSERIALIZED *', maxdd: int) -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def gbox_set_stbox(box: 'const GBOX *', srid: 'int32_t') -> 'STBox *':
    box_converted = _ffi.cast('const GBOX *', box)
    srid_converted = _ffi.cast('int32_t', srid)
...
def spatial_set_stbox(d: 'Datum', basetype: 'meosType', box: 'STBox *') -> 'bool':
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('meosType', basetype)
    box_converted = _ffi.cast('STBox *', box)
...
def tstzspanset_set_stbox(s: 'const SpanSet *', box: 'STBox *') -> None:
...
def stbox_geo(box: 'const STBox *') -> 'GSERIALIZED *':
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeographyinst_in(string: str) -> 'TInstant *':
    string_converted = string.encode('utf-8')
...
def tgeographyseqset_in(string: str) -> 'TSequenceSet *':
    string_converted = string.encode('utf-8')
...
def tgeometryinst_in(string: str) -> 'TInstant *':
    string_converted = string.encode('utf-8')
...
def tgeometryseqset_in(string: str) -> 'TSequenceSet *':
    string_converted = string.encode('utf-8')
...
def tgeoinst_set_stbox(inst: 'const TInstant *', box: 'STBox *') -> None:
    inst_converted = _ffi.cast('const TInstant *', inst)
    box_converted = _ffi.cast('STBox *', box)
...
def tgeo_restrict_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tgeo_restrict_stbox(temp: 'const Temporal *', box: 'const STBox *', border_inc: bool, atfunc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeoinst_restrict_geom(inst: 'const TInstant *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tgeoinst_restrict_stbox(inst: 'const TInstant *', box: 'const STBox *', border_inc: bool, atfunc: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeoseq_restrict_geom(seq: 'const TSequence *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tgeoseq_restrict_stbox(seq: 'const TSequence *', box: 'const STBox *', border_inc: bool, atfunc: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    box_converted = _ffi.cast('const STBox *', box)
...
def tgeoseqset_restrict_geom(ss: 'const TSequenceSet *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: bool) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def tgeoseqset_restrict_stbox(ss: 'const TSequenceSet *', box: 'const STBox *', border_inc: bool, atfunc: bool) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    box_converted = _ffi.cast('const STBox *', box)
...
def spatial_srid(d: 'Datum', basetype: 'meosType') -> 'int32_t':
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def spatial_set_srid(d: 'Datum', basetype: 'meosType', srid: 'int32_t') -> 'bool':
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('meosType', basetype)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tspatialinst_srid(inst: 'const TInstant *') -> 'int':
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tpointseq_linear_trajectory(seq: 'const TSequence *', unary_union: bool) -> 'GSERIALIZED *':
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tgeoseq_stboxes(seq: 'const TSequence *') -> "Tuple['STBox *', 'int']":
    seq_converted = _ffi.cast('const TSequence *', seq)
    count = _ffi.new('int *')
...
def tgeoseq_split_n_stboxes(seq: 'const TSequence *', max_count: int) -> "Tuple['STBox *', 'int']":
    seq_converted = _ffi.cast('const TSequence *', seq)
    count = _ffi.new('int *')
...
def tgeoseqset_stboxes(ss: 'const TSequenceSet *') -> "Tuple['STBox *', 'int']":
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    count = _ffi.new('int *')
...
def tgeoseqset_split_n_stboxes(ss: 'const TSequenceSet *', max_count: int) -> "Tuple['STBox *', 'int']":
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    count = _ffi.new('int *')
...
def tgeominst_tgeoginst(inst: 'const TInstant *', oper: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tgeomseq_tgeogseq(seq: 'const TSequence *', oper: bool) -> 'TSequence *':
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tgeomseqset_tgeogseqset(ss: 'const TSequenceSet *', oper: bool) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tgeom_tgeog(temp: 'const Temporal *', oper: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tgeo_tpoint(temp: 'const Temporal *', oper: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tspatialinst_set_srid(inst: 'TInstant *', srid: 'int32_t') -> None:
    inst_converted = _ffi.cast('TInstant *', inst)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tspatialseq_set_srid(seq: 'TSequence *', srid: 'int32_t') -> None:
    seq_converted = _ffi.cast('TSequence *', seq)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tspatialseqset_set_srid(ss: 'TSequenceSet *', srid: 'int32_t') -> None:
    ss_converted = _ffi.cast('TSequenceSet *', ss)
    srid_converted = _ffi.cast('int32_t', srid)
...
def npoint_as_ewkt(np: 'const Npoint *', maxdd: int) -> str:
...
def npoint_as_hexwkb(np: 'const Npoint *', variant: int) -> "Tuple[str, 'size_t *']":
    np_converted = _ffi.cast('const Npoint *', np)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def npoint_as_text(np: 'const Npoint *', maxdd: int) -> str:
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_as_wkb(np: 'const Npoint *', variant: int) -> "Tuple['uint8_t *', 'size_t *']":
    np_converted = _ffi.cast('const Npoint *', np)
    variant_converted = _ffi.cast('uint8_t', variant)
    size_out = _ffi.new('size_t *')
...
def npoint_from_hexwkb(hexwkb: str) -> 'Npoint *':
    hexwkb_converted = hexwkb.encode('utf-8')
...
def npoint_from_wkb(wkb: 'const uint8_t *', size: 'size_t') -> 'Npoint *':
    wkb_converted = _ffi.cast('const uint8_t *', wkb)
    size_converted = _ffi.cast('size_t', size)
...
def npoint_in(string: str) -> 'Npoint *':
    string_converted = string.encode('utf-8')
...
def npoint_out(np: 'const Npoint *', maxdd: int) -> str:
    np_converted = _ffi.cast('const Npoint *', np)
...
def nsegment_in(string: str) -> 'Nsegment *':
    string_converted = string.encode('utf-8')
...
def nsegment_out(ns: 'const Nsegment *', maxdd: int) -> str:
...
def npoint_make(rid: int, pos: float) -> 'Npoint *':
...
def nsegment_make(rid: int, pos1: float, pos2: float) -> 'Nsegment *':
    rid_converted = _ffi.cast('int64', rid)
...
def geompoint_to_npoint(gs: 'const GSERIALIZED *') -> 'Npoint *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def geom_to_nsegment(gs: 'const GSERIALIZED *') -> 'Nsegment *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def npoint_to_geompoint(np: 'const Npoint *') -> 'GSERIALIZED *':
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_to_nsegment(np: 'const Npoint *') -> 'Nsegment *':
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_to_stbox(np: 'const Npoint *') -> 'STBox *':
    np_converted = _ffi.cast('const Npoint *', np)
...
def nsegment_to_geom(ns: 'const Nsegment *') -> 'GSERIALIZED *':
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def nsegment_to_stbox(np: 'const Nsegment *') -> 'STBox *':
...
def npoint_hash(np: 'const Npoint *') -> 'uint32':
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_hash_extended(np: 'const Npoint *', seed: int) -> 'uint64':
    np_converted = _ffi.cast('const Npoint *', np)
    seed_converted = _ffi.cast('uint64', seed)
...
def npoint_position(np: 'const Npoint *') -> 'double':
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_route(np: 'const Npoint *') -> 'int64':
    np_converted = _ffi.cast('const Npoint *', np)
...
def nsegment_end_position(ns: 'const Nsegment *') -> 'double':
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def nsegment_route(ns: 'const Nsegment *') -> 'int64':
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def nsegment_start_position(ns: 'const Nsegment *') -> 'double':
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def route_geom(rid: int) -> 'GSERIALIZED *':
    rid_converted = _ffi.cast('int64', rid)
...
def route_length(rid: int) -> 'double':
    rid_converted = _ffi.cast('int64', rid)
...
def nsegment_round(ns: 'const Nsegment *', maxdd: int) -> 'Nsegment *':
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def npoint_srid(np: 'const Npoint *') -> 'int32_t':
    np_converted = _ffi.cast('const Npoint *', np)
...
def nsegment_srid(ns: 'const Nsegment *') -> 'int32_t':
    ns_converted = _ffi.cast('const Nsegment *', ns)
...
def npoint_timestamptz_to_stbox(np: 'const Npoint *', t: int) -> 'STBox *':
    np_converted = _ffi.cast('const Npoint *', np)
    t_converted = _ffi.cast('TimestampTz', t)
...
def npoint_tstzspan_to_stbox(np: 'const Npoint *', s: 'const Span *') -> 'STBox *':
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Span *', s)
...
def npoint_cmp(np1: 'const Npoint *', np2: 'const Npoint *') -> 'int':
...
def npoint_eq(np1: 'const Npoint *', np2: 'const Npoint *') -> 'bool':
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_ge(np1: 'const Npoint *', np2: 'const Npoint *') -> 'bool':
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_gt(np1: 'const Npoint *', np2: 'const Npoint *') -> 'bool':
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_le(np1: 'const Npoint *', np2: 'const Npoint *') -> 'bool':
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_lt(np1: 'const Npoint *', np2: 'const Npoint *') -> 'bool':
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_ne(np1: 'const Npoint *', np2: 'const Npoint *') -> 'bool':
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def npoint_same(np1: 'const Npoint *', np2: 'const Npoint *') -> 'bool':
    np1_converted = _ffi.cast('const Npoint *', np1)
    np2_converted = _ffi.cast('const Npoint *', np2)
...
def nsegment_cmp(ns1: 'const Nsegment *', ns2: 'const Nsegment *') -> 'int':
...
def nsegment_eq(ns1: 'const Nsegment *', ns2: 'const Nsegment *') -> 'bool':
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_ge(ns1: 'const Nsegment *', ns2: 'const Nsegment *') -> 'bool':
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_gt(ns1: 'const Nsegment *', ns2: 'const Nsegment *') -> 'bool':
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_le(ns1: 'const Nsegment *', ns2: 'const Nsegment *') -> 'bool':
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_lt(ns1: 'const Nsegment *', ns2: 'const Nsegment *') -> 'bool':
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def nsegment_ne(ns1: 'const Nsegment *', ns2: 'const Nsegment *') -> 'bool':
    ns1_converted = _ffi.cast('const Nsegment *', ns1)
    ns2_converted = _ffi.cast('const Nsegment *', ns2)
...
def npointset_in(string: str) -> 'Set *':
    string_converted = string.encode('utf-8')
...
def npointset_out(s: 'const Set *', maxdd: int) -> str:
    s_converted = _ffi.cast('const Set *', s)
...
def npointset_make(values: 'const Npoint **', count: int) -> 'Set *':
...
def npoint_to_set(np: 'const Npoint *') -> 'Set *':
    np_converted = _ffi.cast('const Npoint *', np)
...
def npointset_end_value(s: 'const Set *') -> 'Npoint *':
    s_converted = _ffi.cast('const Set *', s)
...
def npointset_routes(s: 'const Set *') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
...
def npointset_start_value(s: 'const Set *') -> 'Npoint *':
    s_converted = _ffi.cast('const Set *', s)
...
def npointset_value_n(s: 'const Set *', n: int) -> 'Npoint **':
    s_converted = _ffi.cast('const Set *', s)
...
def npointset_values(s: 'const Set *') -> 'Npoint **':
    s_converted = _ffi.cast('const Set *', s)
...
def contained_npoint_set(np: 'const Npoint *', s: 'const Set *') -> 'bool':
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def contains_set_npoint(s: 'const Set *', np: 'Npoint *') -> 'bool':
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_npoint_set(np: 'const Npoint *', s: 'const Set *') -> 'Set *':
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def intersection_set_npoint(s: 'const Set *', np: 'const Npoint *') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    np_converted = _ffi.cast('const Npoint *', np)
...
def minus_npoint_set(np: 'const Npoint *', s: 'const Set *') -> 'Set *':
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def minus_set_npoint(s: 'const Set *', np: 'const Npoint *') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    np_converted = _ffi.cast('const Npoint *', np)
...
def npoint_union_transfn(state: 'Set *', np: 'const Npoint *') -> 'Set *':
    state_converted = _ffi.cast('Set *', state)
    np_converted = _ffi.cast('const Npoint *', np)
...
def union_npoint_set(np: 'const Npoint *', s: 'const Set *') -> 'Set *':
    np_converted = _ffi.cast('const Npoint *', np)
    s_converted = _ffi.cast('const Set *', s)
...
def union_set_npoint(s: 'const Set *', np: 'const Npoint *') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tnpoint_in(string: str) -> 'Temporal *':
    string_converted = string.encode('utf-8')
...
def tnpoint_out(temp: 'const Temporal *', maxdd: int) -> str:
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpointinst_make(np: 'const Npoint *', t: int) -> 'TInstant *':
    np_converted = _ffi.cast('const Npoint *', np)
    t_converted = _ffi.cast('TimestampTz', t)
...
def tgeompoint_to_tnpoint(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_to_tgeompoint(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_cumulative_length(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_length(temp: 'const Temporal *') -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_positions(temp: 'const Temporal *') -> "Tuple['Nsegment **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tnpoint_route(temp: 'const Temporal *') -> 'int64':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_routes(temp: 'const Temporal *') -> 'Set *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_speed(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_trajectory(temp: 'const Temporal *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_twcentroid(temp: 'const Temporal *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tnpoint_at_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tnpoint_at_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tnpoint_at_npointset(temp: 'const Temporal *', s: 'const Set *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def tnpoint_at_stbox(temp: 'const Temporal *', box: 'const STBox *', border_inc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tnpoint_minus_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tnpoint_minus_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tnpoint_minus_npointset(temp: 'const Temporal *', s: 'const Set *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def tnpoint_minus_stbox(temp: 'const Temporal *', box: 'const STBox *', border_inc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def tdistance_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tdistance_tnpoint_point(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tdistance_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'Temporal *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nad_tnpoint_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def nad_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def nad_tnpoint_stbox(temp: 'const Temporal *', box: 'const STBox *') -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
...
def nad_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'double':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def nai_tnpoint_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'TInstant *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def nai_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'TInstant *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def nai_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'TInstant *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def shortestline_tnpoint_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def shortestline_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'GSERIALIZED *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def shortestline_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'GSERIALIZED *':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tnpoint_tcentroid_transfn(state: 'SkipList *', temp: 'Temporal *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('Temporal *', temp)
...
def always_eq_npoint_tnpoint(np: 'const Npoint *', temp: 'const Temporal *') -> 'int':
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def always_eq_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_npoint_tnpoint(np: 'const Npoint *', temp: 'const Temporal *') -> 'int':
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def always_ne_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_npoint_tnpoint(np: 'const Npoint *', temp: 'const Temporal *') -> 'int':
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_eq_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def ever_eq_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_npoint_tnpoint(np: 'const Npoint *', temp: 'const Temporal *') -> 'int':
    np_converted = _ffi.cast('const Npoint *', np)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def ever_ne_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def ever_ne_tnpoint_tnpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def teq_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
...
def tne_tnpoint_npoint(temp: 'const Temporal *', np: 'const Npoint *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    np_converted = _ffi.cast('const Npoint *', np)
